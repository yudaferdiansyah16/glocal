...
Class Mreferensi_asal_barang extends CI_Model
{
    ...
    {
        parent::__construct();
        $this->table = getdbtpb($this).'.referensi_asal_barang';
        $this->table_id = 'ID';
    ...
    function update($in)
    {
        ...
        sendTPB($this, $this->table, 'update', $in->id);
    }
    ...
    function delete($in)
    {
        ...
        sendTPB($this, $this->table, 'delete', $in->id);
    }
}
