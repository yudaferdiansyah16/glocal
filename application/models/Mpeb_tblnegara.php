...
Class Mpeb_tblnegara extends CI_Model
{
	var $table = 'smartone_peb.tblnegara';
	var $table_id = 'KdEdi';
	...
	function __construct()
	{
		...
		$this->basesql = "select ta.*, tb.Region from $this->table ta inner join smartone_peb.tblregion tb on ta.KdRegion = tb.KdRegion ";
	}
