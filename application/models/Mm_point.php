...
Class Mm_point extends CI_Model
{
	var $table = 'm_point';
	var $table_id = 'id_point';
	...
	function __construct()
	{
		...
		$this->basesql = "select ta.*, tb.nama_workflow, tc.nama_part from $this->table ta, m_workflow tb, m_part tc where ta.id_workflow = tb.id_workflow and ta.id_part = tc.id_part and ta.deleted_at is null";
	}
