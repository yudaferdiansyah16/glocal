...
Class Tproduction_return_request extends CI_Model
{
	...
	function __construct()
	{
		...
		$this->basesql = "select ta.* from $this->table ta where ta.id_jenis_mutasi = '12' and ta.deleted_at is null ";
	}
	...
	function viewDT($in, $opt = true)
	{
		...
		if($num>0){
			...
			foreach ($res->result() as $r){
				...
				$r->kode_mutasi = "<a href='".base_url('production/return_request_material/print/'.$r->id_production)."'>$r->kode_mutasi</a>";
