...
Class Mm_jenis_mutasi extends CI_Model
{
	var $table = 'm_jenis_mutasi';
	var $table_id = 'id_jenis_mutasi';
	...
	function viewBasedIssue()
	{
		$sql = $this->basesql." and id_jenis_mutasi in (5,10,13,16,17,18)";
		$res = $this->db->query($sql);
