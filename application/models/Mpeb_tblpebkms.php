...
Class Mpeb_tblpebkms extends CI_Model
{
	var $table = 'smartone_peb.tblpebkms';
	var $table_id = 'CAR';
	...
	{
		$sql = "select tb.UREDI as uraianKemasan, ta.* from (select * from smartone_peb.tblpebkms where CAR = '$id') ta left join smartone_peb.tblkemasan tb on ta.JnKemas = tb.KDEDI";
		$res = $this->db->query($sql);
