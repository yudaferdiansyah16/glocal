...
Class Mreferensi_tujuan_pengiriman extends CI_Model
{
	...
	{
		parent::__construct();
		$this->table = getdbtpb($this).'.referensi_tujuan_pengiriman';
		$this->table_id = 'ID';
	...
	function getByKodeDokumen($i)
	{
		$sql = $this->basesql." where KODE_DOKUMEN = '$i'";
		$res = $this->db->query($sql);
