...
Class Mm_class extends CI_Model
{
    var $table = 'm_class';
    var $table_id = 'id_class';
    ...
    function __construct()
    {
        ...
        $this->basesql = "select ta.*,tb.nama_jenis_laporan,tc.nama_akun,td.nama_akun as nama_akun_lawan from m_class ta left join m_jenis_laporan tb on ta.id_jenis_laporan = tb.id_jenis_laporan left join m_akun tc on ta.id_akun = tc.id_akun left join m_akun td on ta.id_akun_lawan = td.id_akun where ta.deleted_at is null ";
    }
