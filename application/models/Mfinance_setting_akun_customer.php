...
class Mfinance_setting_akun_customer extends CI_Model
{
    ...
    function __construct()
    {
        ...
        // $this->basesql = "select ta.*, tb.kode_akun as kode_akun_piutang, tb.nama_akun as nama_akun_piutang, tc.kode_akun as kode_akun_um, tc.nama_akun as nama_akun_um, td.kode_akun as kode_akun_jual, td.nama_akun as nama_akun_jual from m_customer_suplier ta left join m_akun tb on ta.id_akun_piutang = tb.id_akun left join m_akun tc on ta.id_akun_um=tc.id_akun left join m_akun td on ta.id_akun_jual=td.id_akun where ta.deleted_at is null and ta.tipe='CUSTOMER'";
        $this->basesql = "select ta.*, tb.kode_akun, tb.nama_akun from m_customer_suplier ta left join m_akun tb on ta.id_akun = tb.id_akun where ta.deleted_at is null and ta.tipe='CUSTOMER'";
    }
