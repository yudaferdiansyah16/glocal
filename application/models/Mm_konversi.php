...
Class Mm_konversi extends CI_Model
{
	var $table = 'm_konversi';
    var $table_id = 'id_konversi';
    ...
    function __construct()
    {
        ...
        $this->basesql = "select ta.*, tb.nama_barang, tc.URAIAN_SATUAN as nama_satuan_terkecil, td.URAIAN_SATUAN as nama_satuan_terbesar from $this->table ta inner join m_sub_barang tb on ta.id_sub_barang = tb.id_sub_barang inner join ".getdbtpb($this).".referensi_satuan tc on ta.id_satuan_terkecil = tc.ID inner join ".getdbtpb($this).".referensi_satuan td on ta.id_satuan_terbesar = td.ID where ta.deleted_at is null ";
    }
