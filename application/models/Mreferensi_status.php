...
Class Mreferensi_status extends CI_Model
{
    ...
    {
        parent::__construct();
        $this->table = getdbtpb($this).'.referensi_status';
        $this->table_id = 'ID';
        $this->nowdt = date('Y-m-d H:i:s');
        $this->nowd = date('Y-m-d');
        $this->nowt = date('H:i:s');
        $this->basesql = "select ta.*, tb.URAIAN_DOKUMEN from $this->table ta inner join ".getdbtpb($this).".referensi_dokumen tb on ta.KODE_DOKUMEN = tb.KODE_DOKUMEN";
    }
