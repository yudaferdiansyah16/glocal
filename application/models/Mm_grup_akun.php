...
Class Mm_grup_akun extends CI_Model
{
    var $table = 'm_grup_akun';
    var $table_id = 'id_grup_akun';
    ...
    function __construct()
    {
        ...
        $this->basesql = "select ta.*, tb.nama_jenis_laporan_keuangan from $this->table ta inner join m_jenis_laporan_keuangan tb on ta.id_jenis_laporan_keuangan = tb.id_jenis_laporan_keuangan where ta.deleted_at is null";
    }
