...
Class Mm_tipe_sales extends CI_Model
{
	var $table = 'm_tipe_sales';
	var $table_id = 'id_tipe_sales';
	...
	function __construct()
	{
		...
		$this->basesql = "select x.*, s.status_trans from $this->table as x inner join m_status as s on s.id_status = x.id_status where x.deleted_at is null";
	}
	...
	function viewActive()
	{
		$sql = $this->basesql." and x.id_status = '1'";
		$res = $this->db->query($sql);
