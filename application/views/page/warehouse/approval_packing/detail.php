			...
			<div class="card mb-g">
                    ...
                    <div class="col-sm-12 col-lg-12 col-xl-12">
                        <dl class="row">
                            ...
                            <dd class="col-sm-12 col-lg-5 col-xl-5">
                                <input type="text" class="form-control form-control-sm" nama="no_job" value="<?=$realisasi->kode_mutasi?>" disabled>
                            </dd>
				...
				<div class="card-footer">
					<?php if ($realisasi->approval_2 == 0 && $realisasi->flag_btl == 0 && $realisasi->flag_closing == 0) { ?>
						<a href="<?=base_url('warehouse/approval_packing/approval2/?id_p='.$realisasi->id_production .'&'.'no_job='. $realisasi->no_job .'&'.'id_wh=' .$reqheader->id_wh)?>" class="btn btn-sm btn-primary"><i class="fal fa fa-check-circle"></i> Approve 2</a>
					<?php }?>
					<?php if ($realisasi->approval_2 == 1 && $realisasi->approval_2 == 1 && $realisasi->flag_btl == 0 && $realisasi->flag_closing == 0) { ?>
						<a href="<?=base_url('warehouse/approval_packing/disapprove2/'.$realisasi->id_production)?>" class="btn btn-sm btn-secondary"><i class="fal fa fa-circle"></i> Disapprove 2</a>
                    <?php }?>
					<a href="<?=base_url('warehouse/approval_packing')?>" class="btn btn-sm btn-info align-rigt"><i class="fal fa-times-circle"></i> Back</a>
				</div>
			</div>
		</div>
	</div>
