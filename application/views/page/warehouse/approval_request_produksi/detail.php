<main id="js-page-content" role="main" class="page-content">
	<ol class="breadcrumb page-breadcrumb">
		...
		<li class="breadcrumb-item">Approval Request Produksi</li>
		<li class="breadcrumb-item active">Detail</li>
		<li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
	</ol>
	<div class="subheader">
		<h1 class="subheader-title">
			Detail Approval Request Produksi
		</h1>
	</div>
	<div class="row">
			...
			<div class="card mb-g">
				...
				<div class="card-footer">
							<?php if ($reqheader->approval_1 == 1 && $reqheader->approval_2 == 0) { ?>
								<a href="<?=base_url($_controller.'/'.$_method.'/approval2/'.$reqheader->id_wh)?>" class="btn btn-sm btn-primary"><i class="fal fa fa-check-circle"></i> Approve 2</a>
							<?php }?>
							<?php if ($reqheader->approval_2 == 1) { ?>
								<a href="<?=base_url($_controller.'/'.$_method.'/disapprove2/'.$reqheader->id_wh)?>" class="btn btn-sm btn-secondary"><i class="fal fa fa-circle"></i> Disapprove 2</a>
							<?php }?>
					<a href="<?=base_url('warehouse/approval_request_produksi')?>" class="btn btn-sm btn-info align-rigt"><i class="fal fa-times-circle"></i> Back</a>
				</div>
			</div>
		</div>
	</div>
