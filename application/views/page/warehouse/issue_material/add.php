	...
	<div class="row">
		<div class="col-sm-12 col-lg-12 col-xl-12">
			<div class="card mb-g">
				<div class="card-body">
					<form method="post" action="<?=base_url('warehouse/issue_material/store')?>">
						<div class="form-group row">
							<div class="col-md-3">
								<label class="form-label">Type of Issue</label>
								<select class="form-control form-control-sm select2" name="t_wh[id_jenis_mutasi]" required>
...
<table class="x-hidden table_template">
	...
	<tr data-index="x">
		...
		<td>
			...
			<input type="hidden" class="id_satuan" name="t_wh_detail[x][id_satuan]"/>
		</td>
		<td>
			<span class="nama_gudang"></span><br>
			<small class="nama_koordinat"></small>
			<input type="hidden" class="id_koordinat_asal" name="t_wh_detail[x][id_koordinat_asal]"/>
		</td>
		<td class="text-right">
