		...
		<div data-size="A4">
			...
			<div class="row">
				...
				<div class="col-sm-1 text-right">
					<div id="qrcode"></div>
					<input type="hidden" id="kode_qrcode" value="<?=$t_request->kode_request?>">
				</div>
			</div>
			<div class="row">
					...
					<div class="table-responsive">
						<table class="table table-clean table-sm align-self-end">
							...
							<tr>
								...
								<td>
									<strong>: <?= $t_request->kode_request ?> </strong>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<strong>:<?= date('d-m-Y', strtotime($t_request->tgl_request)) ?> </strong>
								</td>
							<tr>
							<tr>
								<td>
								...
								<td>
									<strong>: <?= $t_request->nama_jenis_mutasi ?> </strong>
								</td>
							<tr>
							<tr>
								<td>
								...
								<td>
									<strong>:<?= date('d-m-Y H:i', strtotime($t_request->created_at)) ?> by <em><?=$t_request->nama_user_created?> </strong>
								</td>
							<tr>
							<tr>
								<td>
								...
								<td>
									<strong>:<?= date('d-m-Y H:i', strtotime($t_request->created_at)) ?> by <em><?=$t_request->nama_user_updated?> </strong>
								</td>
							<tr>
							</tbody>
						</table>
					...
					<div class="table-responsive">
						<table class="table table-mt-5 table-sm" id="dt" role="grid" style="width: 99%">
							...
							<tr>
								...
								<th class="text-center table-scale-border-bottom table-scale-border-top">Size</th>
					...
					<div class="table-responsive">
						<table class="table table-clean table-sm align-self-end">
							...
							<tr class="form-control-plaintext text-justify">
								<td>
									Request Note  :  <?=$t_request->deskripsi?>
								</td>
							</tr>
							</tbody>
						</table>
