                ...
                <div class="card-body">
                    <form method="post" action="<?= base_url($_controller . '/' . $_method . '/update') ?>">
                        ...
                        <div class="form-group row">                            
                            <div class="col-md-2">
                                <input type="hidden" name="t_wh[id_jenis_mutasi]" value="15" />
                                <label class="form-label">Adjust Date</label>
                                <div class="input-group input-group-sm">
                                    <input type="text" class="form-control form-control-sm x-readonly" readonly="" placeholder="Select date" value="<?= date('d-m-Y', strtotime($t_wh->tanggal_terima)) ?>" required>
                                    ...
                                    <table class="table table-hover table-bordered table-striped table-sm" id="dt_request_add" role="grid">
                                        <thead>
                                            <tr class="text-center">
                                                ...
                                                <th class="text-center" style="width: 120px;">On Hand</th>
                                            ...
                                            <?php foreach ($t_wh_detail as $i => $detail): ?>
                                                <tr data-index="<?= $i ?>">
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="hidden" class="id_koordinat" name="t_wh_detail[<?= $i ?>][id_koordinat]" value="<?= $detail->id_koordinat ?>"/>
                                                    </td>
                                                    <td class="text-right">
                                                    ...
                                                    <td class="text-right">
                                                        <span class="qty_stock_onhand"><?= number_format(($detail->qty_stock+$detail->qty), 2) ?></span><br>
                                                        <small class="kode_satuan"><?= $detail->kode_satuan_terkecil ?></small>
                                                    </td>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <label class="form-label">Adjust Note</label>
