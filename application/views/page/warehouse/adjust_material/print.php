<main id="js-page-content" role="main" class="page-content">
	<ol class="breadcrumb page-breadcrumb">
		...
		<li class="breadcrumb-item">Adjustment Material</li>
					...
					<div class="table-responsive">
						<table class="table table-mt-5 table-sm" id="dt" role="grid" style="width: 99%">
							...
							<tr>
								...
								<th class="text-left table-scale-border-bottom table-scale-border-top">DN Number</th>
								...
								<th class="text-left table-scale-border-bottom table-scale-border-top">Location</th>
								<th class="text-right table-scale-border-bottom table-scale-border-top">Qty Adjustment</th>
							</tr>
							</thead>
							<tbody>
					...
					<div class="table-responsive">
						<table class="table table-clean table-sm align-self-end">
							...
							<tr class="form-control-plaintext text-justify">
								<td>
									Adjustment Note  :  <?=$t_wh->deskripsi?>
								</td>
							</tr>
							</tbody>
						</table>
