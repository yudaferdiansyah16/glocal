<main id="js-page-content" role="main" class="page-content">
	<ol class="breadcrumb page-breadcrumb">
		...
		<li class="breadcrumb-item">Approval Return Request Material</li>
		<li class="breadcrumb-item active">Detail</li>
		<li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
	</ol>
	<div class="subheader">
		<h1 class="subheader-title">
			Approval Detail Return  Request Material
		</h1>
	</div>
	<div class="row">
		<div class="col-sm-12 col-lg-12 col-xl-12">
			<div class="card mb-g">
						...
						<div class="col-md-12">
							<table class="table table-sm table-bordered" role="grid" style="table-layout: fixed">
								<tr>
									...
									<td><?=$rtnheader->tanggal_terima?></td>
								</tr>
							</table>
						</div>
						<div class="col-md-12">
				...
				<div class="card-footer">
					<?php if ($rtnheader->approval_2 == 0) { ?>
						<a href="<?=base_url('production/return_request_material/approval2/'.$rtnheader->id_wh)?>" class="btn btn-sm btn-primary"><i class="fal fa fa-check-circle"></i> Approve 2</a>
					<?php }?>
					<?php if ($rtnheader->approval_1 == 1 && $rtnheader->approval_2 == 1) { ?>
						<a href="<?=base_url('production/return_request_material/disapprove2/'.$rtnheader->id_wh)?>" class="btn btn-sm btn-secondary"><i class="fal fa fa-circle"></i> Disapprove2</a>
					<?php }?>
