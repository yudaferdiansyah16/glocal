		...
		<div class="col-sm-12 col-lg-12 col-xl-12">
			<div class="card mb-g">
				<div class="card-header">
					<button type="button" onclick="confirmDialog(this)" data-header="Confirm Closing" data-body="Do you want to approve this transaction?" data-url="<?=base_url('procurement/closing_pr/approve/')?>" class="btn btn-sm btn-primary"><i class="fal fa fa-check-circle"></i> Closing</button>
