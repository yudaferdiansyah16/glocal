<main id="js-page-content" role="main" class="page-content">
	...
	<div class="row">
		<div class="col-sm-12 col-lg-12 col-xl-12">
			<div class="card mb-g">
				<div class="card-body">
					<form method="post" action="<?=base_url('procurement/purchase_requisition/store')?>">
						<div class="form-group row">
							<div class="col-md-2">
								<label class="form-label">Date</label>
								<div class="input-group input-group-sm">
									<input type="text" class="form-control form-control-sm x-datepicker x-readonly" required placeholder="Select date" name="t_pp[tanggal_dibuat]" value="<?=date('d-m-Y')?>">
							...
							<div class="col-md-2">
								...
								<div class="input-group input-group-sm">
									<input type="text" class="form-control form-control form-control-sm x-datepicker x-readonly" required placeholder="Select date" name="t_pp[tanggal_dibutuhkan]">
									<div class="input-group-append">
										<span class="input-group-text fs-xl">
											<i class="fa fal fa-calendar"></i>
										</span>
								...
								<div class="table-responsive">
									<table class="table table-hover table-bordered table-striped table-sm" id="dt_pp_rutin_add" role="grid">
										...
										<tr>
											...
											<th class="text-center" style="width: 250px;">No Job</th>
											<th class="text-center">Nama Barang</th>
											<th class="text-center">Current<br>Stock</th>
...
<!--			<input type="text" class="form-control form-control-sm x-readonly nama_barang" readonly placeholder=""/>-->
		...
		<td>
			<input type="text" class="form-control form-control-sm qty_pp input-mask" name="t_detail_pp[x][qty_pp]" data-inputmask="'alias': 'currency', 'prefix': ''"/>
		</td>
		<td>
