			...
			<div class="row">
				<div class="col-sm-2">
					<div class="img-container mb-3" align="left">
						<img src="<?= assets_url('img/'.$app->img) ?>" alt="DPS" aria-roledescription="logo" height="60" width="auto">
					</div>
				</div>
				<div class="col-sm-8">
				...
				<div class="col-sm-2 text-right">
					<div id="qrcode"></div>
					<input type="hidden" id="kode_qrcode" value="<?=$ppheader->kode_pp?>">
				</div>
			</div>
			<div class="row">
					...
					<div class="table-responsive">
						<table class="table table-clean table-sm align-self-end">
							...
							<tr>
								...
								<td>
									<strong>: <?= date('d-m-Y', strtotime($ppheader->tanggal_dibutuhkan))?></strong>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<strong>: <?=$ppheader->nama_bagian?></strong>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<strong>: <?=$ppheader->nama_jenis_pp?></strong>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<strong>: <?=$ppheader->nama_jenis_pp_rutinitas?></strong>
								</td>
							</tr>
							</tbody>
						</table>
					...
					<div class="table-responsive">
						<table class="table table-mt-5 table-sm" id="dt" role="grid" style="width: 99%">
							...
							<tr>
								...
								<th class="text-left table-scale-border-bottom table-scale-border-top">Barang</th>
								<th class="text-right table-scale-border-bottom table-scale-border-top">Quantity</th>
								<th class="text-center table-scale-border-bottom table-scale-border-top">Remark</th>
							</tr>
							</thead>
							<tbody>
								<?php
							...
							<tfoot>
								<tr>
									<th colspan="5" class="text-center table-scale-border-bottom table-scale-border-top"></th>
								</tr>
							</tfoot>
						</table>
					</div>
