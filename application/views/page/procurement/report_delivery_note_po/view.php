<main id="js-page-content" role="main" class="page-content">
	<ol class="breadcrumb page-breadcrumb">
		...
		<li class="breadcrumb-item active">Report Delivery Note PO</li>
		<li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
	</ol>
	<div class="subheader">
		<h1 class="subheader-title">Report Delivery Note PO</h1>
	</div>
	<div class="row">
					...
					<div class="row">
						<div class="col-md-2">
							...
							<select class="form-control form-control-sm id_fasilitas form-filter">
								...
								<?=createOption($m_fasilitas,'id_fasilitas',array('nama_fasilitas'),'-')?>
							</select>
						</div>
						<div class="col-md-4">
