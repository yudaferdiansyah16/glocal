		...
		<div class="col-sm-12 col-lg-6 col-xl-6">
			<div class="card mb-g">
				<div class="card-header">
					<div class="row">
						<div class="col-md-12">
							<form method="post" action="<?=base_url('production/realisasi_request_material/add')?>">
								<div class="form-group">
									...
									<div class="input-group input-group-sm">
										...
										<div class="input-group-append">
											<button type="button" class="btn btn-default" data-toggle="modal" data-target="#realisasi_request_modal"><i class="fal fa-search"></i></button>
										</div>
									</div>
								</div>
								<div class="form-group">
									<button type="submit" class="btn btn-sm btn-success"><i class="fal fa fa-save"></i> Filter</button>
									<a href="<?=base_url('production/realisasi_request_material')?>" class="btn btn-sm btn-danger"><i class="fal fa-times-circle"></i> <?=$this->lang->line('button_cancel')?></a>
								</div>
							</form>
						</div>
					</div>
