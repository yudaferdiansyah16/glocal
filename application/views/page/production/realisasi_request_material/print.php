		...
		<div data-size="A4">
			...
			<div class="row">
				...
				<div class="col-sm-1 text-right">
					<div id="qrcode"></div>
					<input type="hidden" id="kode_qrcode" value="<?=$rlzheader->kode_mutasi?>">
				</div>
			</div>
			<div class="row">
					...
					<div class="table-responsive">
						<table class="table table-clean table-sm align-self-end">
							...
							<tr>
								...
								<td>
									<strong>: <?=$rlzheader->kode_mutasi?></strong>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<strong>: <?=$rlzheader->tanggal_mutasi?> </strong>
								</td>
							</tbody>
						</table>
					</div>
				...
				<div class="col-sm-12">
					<div class="table-responsive">
						<table class="table table-mt-5 table-sm" id="dt" role="grid" style="width: 99%">
							...
							$i = 0;
							?>
							<?php foreach ($rlzdetail as $detail): ?>
								<tr>
...
<nav class="shortcut-menu d-none d-sm-block">
	...
	<a href="#" class="menu-item btn" data-toggle="2tooltip" data-placement="left" title="Scroll Top">
