			...
			<div class="card mb-g">
				...
				<div class="card-footer">
					<?php if ($realisasi->approval_1 == 0 && $realisasi->flag_btl == 0 && $realisasi->flag_closing == 0) { ?>
						<a href="<?=base_url('production/packing/approval1/?id_p='.$realisasi->id_production .'&'.'id_d_p='. $realisasi->id_production_detail)?>" class="btn btn-sm btn-primary"><i class="fal fa fa-check-circle"></i> Approve 1</a>
					<?php }?>
					<?php if ($realisasi->approval_1 == 1 && $realisasi->approval_2 == 0 && $realisasi->flag_btl == 0 && $realisasi->flag_closing == 0) { ?>
						<a href="<?=base_url('production/packing/disapprove1/'.$realisasi->id_production)?>" class="btn btn-sm btn-secondary"><i class="fal fa fa-circle"></i> Disapprove</a>
                    <?php }?>
					<a href="<?=base_url('production/packing')?>" class="btn btn-sm btn-info align-rigt"><i class="fal fa-times-circle"></i> Back</a>
				</div>
			</div>
		</div>
	</div>
