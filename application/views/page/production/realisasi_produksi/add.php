<main id="js-page-content" role="main" class="page-content">
	<ol class="breadcrumb page-breadcrumb">
		...
		<li class="breadcrumb-item">Realisasi Produksi</li>
		<li class="breadcrumb-item active">Add</li>
		<li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
	</ol>
	<div class="subheader">
		<h1 class="subheader-title">
			Add Realisasi Produksi
		</h1>
	</div>
	<div class="row">
		<div class="col-sm-12 col-lg-12 col-xl-12">
			<div class="card mb-g">
				<div class="card-body">
					<form method="post" action="<?= base_url('production/realisasi_produksi/store') ?>">
										...
										<div class="tab-content" id="myTabContent">
															...
															<table id="dt_material" class="table table-sm table-bordered table-striped table-hover">
																<thead>
																	<tr class="text-center">
																		...
																		<th class="text-center" rowspan="2" width="80px">Add Item<button type="button" class="btn btn-xs btn-success" data-toggle="modal" data-target="#t_production_detail_realisasi_material_modal"><i class="fal fa-plus-circle"></i></button></th>
																	</tr>
																	<tr class="text-center">
																		<th>Nama</th>
																		<th>Satuan</th>
											...
											<div class="tab-pane fade" id="tab_scrap" role="tabpanel" aria-labelledby="profile-tab">
												<div class="row" style="margin-top: 15px;">
													<div class="col-md-12">
														<div class="table-responsive">
															<table id="dt_scrap" class="table table-sm table-bordered table-striped table-hover">
																<thead>
																	<tr class="text-center">
																		<th rowspan="2">No.</th>
																		<th rowspan="2">No Request / Bon Bahan</th>
											...
											<div class="tab-pane fade" id="tab_waste" role="tabpanel" aria-labelledby="profile-tab">
												<div class="row" style="margin-top: 15px;">
													<div class="col-md-12">
														<div class="table-responsive">
															<table id="dt_waste" class="table table-sm table-bordered table-striped table-hover">
																<thead>
																	<tr class="text-center">
																		<th rowspan="2">No.</th>
																		<th rowspan="2">No Request / Bon Bahan</th>
											...
											<div class="tab-pane fade" id="tab_return" role="tabpanel" aria-labelledby="contact-tab">
												<div class="row" style="margin-top: 15px;">
													<div class="col-md-12">
														<div class="table-responsive">
															<table id="dt_return" class="table table-sm table-bordered table-striped table-hover">
																<thead>
																	<tr class="text-center">
																		<th rowspan="2">No.</th>
																		<th rowspan="2">No Request / Bon Bahan</th>
											...
											<div class="tab-pane fade" id="tab_loss" role="tabpanel" aria-labelledby="contact-tab">
												<div class="row" style="margin-top: 15px;">
													<div class="col-md-12">
														<div class="table-responsive">
															<table id="dt_loss" class="table table-sm table-bordered table-striped table-hover">
																<thead>
																	<tr class="text-center">
																		<th rowspan="2">No.</th>
																		<th rowspan="2">No Request / Bon Bahan</th>
...
<table class="x-hidden table_template_material">
	<tbody>
	<tr data-index="x">
		<td class="text-center">1</td>
		<td class="text-center">
			<p class="text_kode_produksi_material"></p>
		</td>
		<td class="text-center">
			<p class="text_no_job_material"></p>
			<input type="hidden" class="id_job_material" name="t_production_detail_material[x][id_job]"/>
		</td>
		<td>
			<p class="text_nama_barang_material" style="margin: 0;padding: 0"></p>
			<small class="text_kode_barang_material" style="margin: 0;padding: 0"></small>
			<input type="hidden" class="id_sub_barang_material" name="t_production_detail_material[x][id_sub_barang]"/>
			<!-- <input type="hidden" class="id_wh_detail" name="id_wh_detail"/> -->
			<input type="hidden" class="tanggal_mutasi" name="t_production[tanggal_mutasi]"/>
			<input type="hidden" class="id_detail_dn" name="t_production[id_detail_dn]"/>
			<input type="hidden" class="seri_barang_material" name="t_production_detail_material[x][seri_barang]"/>
			<input type="hidden" class="id_wh_detail_material" name="t_production_detail_material[x][id_wh_detail]"/>
		</td>
		<td class="text-center">
			<p class="text_satuan_material"></p>
		</td>
		<td class="text-right">
			<p class="text_qty_request_material"></p>
			<input type="hidden" class="form-control form-control-sm qty_request_material" name="t_production_detail_material[x][qty_max]"/>
		</td>
		<td>
			<input type="number" class="form-control form-control-sm qty_material" step="0.01" min="0" name="t_production_detail_material[x][qty]"/>
		</td>
		<td class="text-center">
...
<table class="x-hidden table_template_fg">
	...
	<tr data-index="x">
		...
		<td>
			<input type="number" class="form-control form-control-sm qty_fg" step="0.01" min="0" name="t_production_detail_fg[x][qty]"/>
		</td>
		<td class="text-center">
			<button class="btn btn-xs btn-danger btn-delete-row"><i class="fa fal fa-trash"></i></button>
		</td>
...
<table class="x-hidden table_template_return">
	<tbody>
	<tr data-index="x">
		<td class="text-center text_no_return">1</td>
		<td class="text-center">
			<p class="text_kode_produksi_return"></p>
		</td>
		<td class="text-center">
			<p class="text_no_job_return"></p>
			<input type="hidden" class="id_job_return" name="t_production_detail_return[x][id_job]"/>
		</td>
		<td>
			<p class="text_nama_barang_return" style="margin: 0;padding: 0"></p>
			<small class="text_kode_barang_return" style="margin: 0;padding: 0"></small>
			<input type="hidden" class="id_sub_barang_return" name="t_production_detail_return[x][id_sub_barang]"/>
			<input type="hidden" class="seri_barang_return" name="t_production_detail_return[x][seri_barang]"/>
			<input type="hidden" class="id_wh_detail_return" name="t_production_detail_return[x][id_wh_detail]"/>
		</td>
		<td class="text-center">
			<p class="text_satuan_return"></p>
		</td>
		<td>
			<input type="number" class="form-control form-control-sm qty_return" step="0.01" min="0" name="t_production_detail_return[x][qty]"/>
		</td>
	</tr>
	</tbody>
</table>
