		...
		<div data-size="A4">
			<div class="row">
				...
				<div class="col-sm-1 text-right">
					<div id="qrcode"></div>
					<input type="hidden" id="kode_qrcode" value="<?=$t_production->kode_mutasi?>">
				</div>
			</div>
			<div class="row">
					...
					<div class="table-responsive">
						<table class="table table-clean table-sm align-self-end">
							...
							<tr>
								...
								<td>
									<strong>: <?= date('d-m-Y', strtotime($t_production->tanggal_mutasi)) ?></strong>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<strong>: <?= $t_production->no_job ?></strong>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<strong>: <?= $t_production->nama_barang ?></strong>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<strong>: <?= number_format($t_production->qty_pack) ?> <?=$t_production->kode_satuan?></strong>
								</td>
							</tr>
							</tbody>
						</table>
					...
					<div class="table-responsive">
						<table class="table table-mt-5 table-sm" id="dt" role="grid" style="width: 99%">
							...
							<tr>
								...
								<th class="text-left table-scale-border-bottom table-scale-border-top">Item Material</th>
								<th class="text-left table-scale-border-bottom table-scale-border-top">Production Code</th>
								<th class="text-left table-scale-border-bottom table-scale-border-top">Job Number</th>
							...
							<?php foreach ($t_production_detail as $i => $detail): ?>
								<tr>
									...
									<td class="text-left">
										<?=$detail->kode_mutasi_old?>
									</td>
									<td class="text-left">
										<?= $detail->no_job ?>
									</td>
									<td class="text-right">
										<?= number_format($detail->qty, 0) ?><?= $detail->kode_satuan ?>
								</tr>
				...
				<div class="col-sm-4 ml-sm-auto">
					<table class="table table-clean">
						...
						<tr class="table-scale-border-top border-left-0 border-right-0 border-bottom-0">
							...
							<td class="text-left keep-print-font">
								<span class="m-0 fw-700 h2 keep-print-font"><?=number_format($total_pp, 0)?> </span>
