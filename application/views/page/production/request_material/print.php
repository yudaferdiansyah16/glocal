		...
		<div data-size="A4">
			...
			<div class="row">
				...
				<div class="col-sm-1 text-right">
					<div id="qrcode"></div>
					<input type="hidden" id="kode_qrcode" value="<?=$reqheader->kode_mutasi?>">
				</div>
			</div>
			<div class="row">
					...
					<div class="table-responsive">
						<table class="table table-clean table-sm align-self-end">
							...
							<tr>
								...
								<td>
									<strong>: <?=$reqheader->kode_mutasi?></strong>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<strong>: <?=$reqheader->tanggal_mutasi?> </strong>
								</td>
							</tbody>
						</table>
					</div>
					...
					<div class="table-responsive">
						<table class="table table-mt-5 table-sm" id="dt" role="grid" style="width: 99%">
							...
							<tr>
								...
								<th class="text-left table-scale-border-bottom table-scale-border-top">No Aju</th>
								<th class="text-left table-scale-border-bottom table-scale-border-top">No Pendaftaran</th>
								<th class="text-right table-scale-border-bottom table-scale-border-top">No DN</th>
								<th class="text-center table-scale-border-bottom table-scale-border-top">Job</th>
								<th class="text-center table-scale-border-bottom table-scale-border-top">Item Code</th>
								<th class="text-center table-scale-border-bottom table-scale-border-top">Item</th>
							...
							$i = 0;
							?>
							<?php foreach ($reqdetail as $detail): ?>
								<tr>
									<td class="text-center"><?= $i + 1 ?></td>
									<td class="text-left"><?= $detail->nomor_aju ?></td>
									<td class="text-left">
										<?= $detail->nomor_daftar?>
									</td>
									<td class="text-right">
								...
								<?php $total_req += floatval($detail->qty) ?>
								<?php $i++; endforeach; ?>
				...
				<div class="col-sm-4 ml-sm-auto">
					<table class="table table-clean">
						...
						<tr class="table-scale-border-top border-left-0 border-right-0 border-bottom-0">
							...
							<td class="text-left keep-print-font">
								<span class="m-0 fw-700 h2 keep-print-font"><?=number_format($total_req, 3)?> </span>
