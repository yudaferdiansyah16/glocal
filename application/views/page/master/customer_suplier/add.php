<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="row">
        <div class="col-sm-12 col-lg-8 col-xl-8">
            <div class="card mb-g">
                <div class="card-body">
                    <form method="post" action="<?= base_url('master/customer_suplier/store') ?>">
                        <div class="form-group row">
                            <div class="col-sm-12 col-lg-4">
                                <label class="form-label">Tipe</label>
                                <select class="form-control form-control-sm select2" name="tipe">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 col-lg-4">
                                ...
                                <input type="text" class="form-control form-control-sm" name="nama_consignee">
                            </div>
                            <div class="col-sm-12 col-lg-8">
                                <label class="form-label">Tujuan Pengiriman</label>
                                <input type="text" class="form-control form-control-sm" name="destinasi">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-12 col-lg-4">
