		...
		<div class="col-sm-12 col-lg-12 col-xl-12">
			<div class="card mb-g">
				<div class="card-header">
					...
					<a href="<?=base_url('master/job/add/'.$t_bom->id_bom)?>" class="btn btn-sm btn-primary"><i class="fal fa fa-plus-circle"></i> Add New</a>
				...
				<div class="card-body">
					<dl class="row">
						...
						<dd class="col-sm-10"><?=$t_bom->kode_po?> <?=$t_bom->id_po?></dd>
