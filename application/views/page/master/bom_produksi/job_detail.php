			...
			<div class="card mb-g">
				<div class="card-body">
					<form method="post" action="<?=base_url('master/job/detail_update')?>">
						...
						<div class="row">
							<div class="col-md-12">
								<button type="submit" class="btn btn-sm btn-success"><i class="fa fal fa-save"></i> <?=$this->lang->line('button_save')?></button>
								<a href="<?=base_url('master/bom_produksi/job/'.$t_job->id_bom)?>" class="btn btn-sm btn-danger"><i class="fal fa fa-times-circle"></i> Back</a>
							</div>
						</div>
					</form>
