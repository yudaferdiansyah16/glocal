<main id="js-page-content" role="main" class="page-content">
	...
	<div class="container">
		<div data-size="A4">
			...
			<div class="row">
				<div class="col-sm-9">
					<dl class="row">
						...
						<dd class="col-sm-9"><?=(!empty($nama_workflow) ? $nama_workflow : '-')?></dd>
					</dl>
				</div>
			...
			<div class="row">
				<div class="col-md-12">
					<?php foreach ($notes as $bom_workflow):?>
						<div class="form-group row">
							<label class="col-md-12"><h4><b><?=$bom_workflow->nama_part?></b></h4></label>
							<div class="col-md-12"><?=$bom_workflow->note?></div>
						</div>
					<?php endforeach; ?>
				</div>
			</div>
