<main id="js-page-content" role="main" class="page-content">
	...
	<div class="row">
		<div class="col-sm-12 col-lg-6 col-xl-6">
			<div class="card mb-g">
				<div class="card-body">
					<form method="post" action="<?=base_url('master/fasilitas/store')?>">
						<div class="form-group row">
							<div class="col-md-12">
								<label class="form-label"><?=$this->lang->line('label_nama_fasilitas_fasilitas')?></label>
								<input type="text" name="nama_fasilitas" class="form-control form-control-sm" placeholder="" value="<?=isset($nama_fasilitas)? $nama_fasilitas: '';?>" required>
							</div>
							<div class="col-md-12">
