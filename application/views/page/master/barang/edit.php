					...
					<form method="post" action="<?=base_url('master/barang/update')?>">
						...
						<div class="form-group row">
							...
							<div class="col-md-6">
								...
								<input type="text" name="unit_konversi" class="form-control form-control-sm input-mask" data-inputmask="'alias': 'currency', 'prefix': ''" value="<?=placeValue($data,'unit_konversi')?>">
							</div>
							<div class="col-md-6">
								<label class="form-label"><?=$this->lang->line('label_kode_hs_barang')?></label>
								<div class="input-group input-group-sm">
									<input type="text" class="form-control form-control-sm" name="kode_hs" placeholder="" value="<?=placeValue($data,'kode_hs')?>" required/>
									<div class="input-group-append">
