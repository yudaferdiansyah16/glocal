<main id="js-page-content" role="main" class="page-content">
	...
	<div class="row">
		<div class="col-sm-12 col-lg-6 col-xl-6">
			<div class="card mb-g">
				<div class="card-body">
					<form method="post" action="<?=base_url('master/style/update')?>">
						<input type="hidden" name="id_style" value="<?=placeValue($data,'id_style')?>">
						<div class="form-group">
							<label class="form-label"><?=$this->lang->line('label_kode_style')?></label>
							<input type="text" name="kode_style" class=" form-control  form-control-sm" placeholder="" value="<?=placeValue($data,'kode_style');?>">
						</div>
						<div class="form-group">
							<label class="form-label"><?=$this->lang->line('label_nama_style')?></label>
							<input type="text" name="nama_style" class=" form-control  form-control-sm" placeholder="" value="<?=placeValue($data,'nama_style')?>">
						</div>
						<div class="form-group">
