<main id="js-page-content" role="main" class="page-content">
	...
	<div class="row">
		<div class="col-sm-12 col-lg-6 col-xl-6">
			<div class="card mb-g">
				<div class="card-body">
					<form method="post" action="<?=base_url('master/asal_fasilitas/store')?>">
						<div class="form-group">
							<label class="form-label"><?=$this->lang->line('label_nama_fasilitas_asal_fasilitas')?></label>
							<input type="text" name="nama_asal" class=" form-control  form-control-sm" placeholder="" value="<?=isset($nama_asal) ? $nama_asal : ''?>" required>
						</div>
						<div class="form-group">
