<main id="js-page-content" role="main" class="page-content">
	<ol class="breadcrumb page-breadcrumb">
		...
		<li class="breadcrumb-item active"><?=$this->lang->line('button_add')?></li>
		<li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
	</ol>
	<div class="subheader">
		<h1 class="subheader-title">
			<?=$this->lang->line('button_add')?> Coordinat <small><?=$m_gudang->nama_gudang?></small>
		</h1>
	</div>
	<div class="row">
		<div class="col-sm-6 col-lg-6 col-xl-6">
			<div class="card mb-g">
				<div class="card-body">
					<form method="post" action="<?=base_url('master/gudang/koordinat_store')?>">
						<input type="hidden" name="id_gudang" value="<?=$m_gudang->id_gudang?>">
						<div class="form-group">
							<label class="form-label">Coordinate Name</label>
							<input type="text" name="nama_koordinat" class=" form-control  form-control-sm" placeholder="" required>
						</div>
						<div class="form-group">
