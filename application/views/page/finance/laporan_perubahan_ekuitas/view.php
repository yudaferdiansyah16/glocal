<main id="js-page-content" role="main" class="page-content">
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item active">Laporan Perubahan Ekuitas</li>
        <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
    </ol>
    <div class="subheader">
        <h1 class="subheader-title">Laporan Perubahan Ekuitas</h1>
    </div>
    <div class="row">
                                ...
                                <table id="dt" class="table table-hover table-bordered table-striped table-sm" id="dt" role="grid" style="white-space: nowrap">
                                    <thead>
                                        <tr class="text-center">
                                            ...
                                            <th class="text-center">Modal Ditempatkan dan Disetor Penuh</th>
                                            <th class="text-center">Tambahan Modal Disetor</th>
                                            <th class="text-center">Saldo Laba</th>
					    <th class="text-center">Komponen Ekuitas Lainnya</th>
