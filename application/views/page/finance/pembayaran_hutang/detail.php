					...
					<form method="post" action="<?=base_url('finance/pembayaran_hutang/payment')?>">
						<div class="row">
							...
							<div class="col-md-4">
								...
								<input type="hidden" name="hakun" value="1">
								<input type="hidden" name="vendor" value="<?=$hutang->vendor?>">
								<!-- <input type="hidden" name="hakun" value="<?=$akun_hutang->id_akun?>"> -->
							</div>
							<div class="col-md-2">
							...
							<div class="col-md-4">
								<p>: <input type="hidden" name="sisa" value="<?=$hutang->nilai-$hutang->jumlah?>"><?=number_format($hutang->nilai/3, 2)?></p>
							</div> -->
							<div class="col-md-2">
								<p><b>Valuta</b></p>
							</div>
