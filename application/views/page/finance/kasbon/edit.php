<main id="js-page-content" role="main" class="page-content">
	...
	<div class="row">
		<div class="col-sm-12 col-lg-12 col-xl-12">
			<div class="card mb-g">
				<div class="card-body">
					<form method="post" action="<?=base_url('finance/kasbon/store2/'.$idkasbon)?>">
						<div class="card-body">
							<div class="row">
								<div class="col-md-2">
									<p><b>Date</b></p>
						...
						<div class="form-group">
							...
							<a href="<?=base_url('finance/kasbon')?>" class="btn btn-sm btn-danger"><i class="fal fa-times-circle"></i> Cancel</a>
						</div>
					</form>
				</div>
			</div>
