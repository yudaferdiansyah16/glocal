				...
				<div class="card-body">
					...
					<div class="card-footer">
						<?php if ($kasbonheader->status_kasbon == 1 ) { ?>
							<a href="<?=base_url('finance/kasbon/approval/'.$kasbonheader->id_kasbon)?>" class="btn btn-sm btn-success"><i class="fal fa fa-check-circle"></i> Approve </a>
						<?php }?>
						<a href="<?=base_url('finance/kasbon')?>" class="btn btn-sm btn-info align-rigt"><i class="fal fa-times-circle"></i> Back</a>
					</div>
				</div>
			</div>
		</div>
