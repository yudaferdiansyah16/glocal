	...
	<div class="row">
		<div class="col-sm-12 col-lg-12 col-xl-12">
			...
			<div class="card-header">
					<?php if ($kasbonheader->status_kasbon == 2) { ?>
					...
					<?php } else if ($kasbonheader->status_kasbon == 1) {?>
						<button type="button" disabled class="btn btn-warning btn-sm btn-pills waves-effect waves-themed">
							<i class="fa fal fa-hourglass-start"></i> Waiting for Approve
						</button>
					<?php } ?>
				</div>
				<div class="card-body">
					...
					<div class="card-footer">
						<?php if ($kasbonheader->status_kasbon == 1 ) { ?>
							<a href="<?=base_url('finance/approval_kasbon/approval/'.$kasbonheader->id_kasbon)?>" class="btn btn-sm btn-success"><i class="fal fa fa-check-circle"></i> Approve </a>
						<?php }?>
						<a href="<?=base_url('finance/approval_kasbon')?>" class="btn btn-sm btn-info align-rigt"><i class="fal fa-times-circle"></i> Back</a>
					</div>
				</div>
			</div>
		</div>
