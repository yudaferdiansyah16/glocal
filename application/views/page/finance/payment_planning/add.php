						...
						<div class="form-group row">
							...
							<div class="col-md-3">
								...
								<div class="input-group input-group-sm">
									<input type="text" class="form-control form-control-sm x-datepicker x-readonly" readonly placeholder="Select date" name="">
							...
							<div class="col-md-3">
								...
								<div class="input-group input-group-sm">
									...
									<input type="hidden" class="kode_valuta" name=""/>
									<div class="input-group-append">
							...
							<div class="col-md-3">
								...
								<input type="text" class="form-control form-control-sm x-readonly rates" readonly name=""/>
							</div>
						</div>
