<main id="js-page-content" role="main" class="page-content">
	...
	<div class="subheader">
		<h1 class="subheader-title">
			Edit Main Sales Order <small><?=$t_po->kode_po?></small>
		</h1>
	</div>
	<div class="row">
		<div class="col-sm-12 col-lg-12 col-xl-12">
			<div class="card mb-g">
				<div class="card-body">
					<form method="post" action="<?=base_url('sales/main_so/update')?>" autocomplete="off">
						...
						<div class="form-group row">
							...
							<div class="col-md-7">
								...
								<div class="input-group input-group-sm">
									<input type="text" class="form-control form-control form-control-sm x-readonly name_supplier" readonly placeholder="Select customer..." value="<?=$t_po->nama_supplier?>" required>
									<input type="hidden" name="t_po[id_supplier]" value="<?=$t_po->id_supplier?>"/>
									<div class="input-group-append">
