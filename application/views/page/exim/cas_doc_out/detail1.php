<main id="js-page-content" role="main" class="page-content">
	<ol class="breadcrumb page-breadcrumb">
		...
		<li class="breadcrumb-item">CAS Doc In</li>
		...
		<div class="col-sm-12 col-lg-12 col-xl-12">
			<div class="card mb-g">
				<div class="card-header">
					<a href="<?=base_url('exim/cas_doc_out/approval1/'.$tpbHeader->ID)?>" class="btn btn-sm btn-primary"><i class="fal fa fa-check-circle"></i> Sync Now</a>
				</div>
				<div class="card-body">
					<div class="row">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="table-responsive">
								...
								<table class="table table-hover table-bordered table-striped table-sm" id="dt_doc_out_detail" role="grid" style="white-space: nowrap;overflow-x: auto">
									<thead>
									<tr>
