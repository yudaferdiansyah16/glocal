	...
	<div class="col-sm-12 col-lg-12 col-xl-12">
		<div class="row">
			...
			<div class="col-md-3 x-hidden dokumen_template include-25 include-30 include-261 include-27">
				...
				<input type="text" class="form-control form-control-sm input-mask" data-inputmask="'alias': 'currency', 'prefix': ''" name="" placeholder=""/>
			</div>
			...
			<div class="col-md-3 x-hidden dokumen_template include-30 ">
