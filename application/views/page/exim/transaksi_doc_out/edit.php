	...
	<div class="row">
		<div class="col-sm-12 col-lg-12 col-xl-12">
			<div class="card mb-g">
				...
				<?php
				if ($tpbHeader->KODE_DOKUMEN_PABEAN == '25') include 'edit_25.php';
				if ($tpbHeader->KODE_DOKUMEN_PABEAN == '261') include 'edit_261.php';
				if ($tpbHeader->KODE_DOKUMEN_PABEAN == '27') include 'edit_27.php';
				if ($tpbHeader->KODE_DOKUMEN_PABEAN == '41') include 'edit_41.php';
				?>
