<div class="card-body">
	...
	<div class="row" style="margin-top: 15px; padding-top: 15px; border-style: dotted; border-width:1px;">
		<div class="col-md-12">
			...
			<a href="#" data-toggle="modal" data-target="#m_data_barang_out_modal"><b>KONTAINER (F5)</b></a>
		</div>
	...
	<div class="col-sm-12 col-lg-6 col-xl-6" style="margin-top: 15px;">
		...
		<div class="col-sm-12 col-lg-12 col-xl-12" style="margin-top:15px; border-style:dotted; border-width:1px;">
			<dl class="row">
				<dt class="col-sm-11"><u><a class="col-sm-3"><a href="#" data-toggle="modal" data-target="#m_jaminan_modal">26. JAMINAN [F3]</a></u></dt>
