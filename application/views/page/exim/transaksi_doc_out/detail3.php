	...
	<div class="row">
		<div class="col-sm-12 col-lg-12 col-xl-12">
			<div class="card mb-g">
				...
				if ($tpbHeader->KODE_DOKUMEN_PABEAN == '27') include 'detail_27OUT.php';
				if ($tpbHeader->KODE_DOKUMEN_PABEAN == '40') include 'detail_40.php';
				?>
				<div class="card-footer">
					<a href="<?=base_url('exim/transaksi_doc_out/')?>" class="btn btn-sm btn-info"><i class="fal fa fa-times-circle"></i> Back</a>
				</div>
			</div>
		</div>
	</div>
