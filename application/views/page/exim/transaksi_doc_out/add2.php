									...
									<div class="table-responsive">
										<table class="table table-sm">
											...
											<tr>
												<td>BM</td>
												<td>
													<input type="text" class="form-control form-control-sm input-mask" data-inputmask="'alias': 'currency', 'prefix': ''" name="bm_ditangguhkan" placeholder=""/>
												</td>
												<td>
													<input type="text" class="form-control form-control-sm input-mask" data-inputmask="'alias': 'currency', 'prefix': ''" name="bm_dibebaskan" placeholder=""/>
												</td>
												<td>
													<input type="text" class="form-control form-control-sm input-mask" data-inputmask="'alias': 'currency', 'prefix': ''" name="bm_tidak_dipungut" placeholder=""/>
												</td>
											</tr>
											<tr>
												<td>BMT</td>
												<td>
													<input type="text" class="form-control form-control-sm input-mask" data-inputmask="'alias': 'currency', 'prefix': ''" name="bmt_ditangguhkan" placeholder=""/>
												</td>
												<td>
													<input type="text" class="form-control form-control-sm input-mask" data-inputmask="'alias': 'currency', 'prefix': ''" name="bmt_dibebaskan" placeholder=""/>
												</td>
												<td>
													<input type="text" class="form-control form-control-sm input-mask" data-inputmask="'alias': 'currency', 'prefix': ''" name="bmt_tidak_dipungut" placeholder=""/>
												</td>
											</tr>
											<tr>
												<td>CUKAI</td>
												<td>
													<input type="text" class="form-control form-control-sm input-mask" data-inputmask="'alias': 'currency', 'prefix': ''" name="cukai_ditangguhkan" placeholder=""/>
												</td>
												<td>
													<input type="text" class="form-control form-control-sm input-mask" data-inputmask="'alias': 'currency', 'prefix': ''" name="cukai_dibebaskan" placeholder=""/>
												</td>
												<td>
													<input type="text" class="form-control form-control-sm input-mask" data-inputmask="'alias': 'currency', 'prefix': ''" name="cukai_tidak_dipungut" placeholder=""/>
												</td>
											</tr>
											<tr>
												<td>PPN</td>
												<td>
													<input type="text" class="form-control form-control-sm input-mask" data-inputmask="'alias': 'currency', 'prefix': ''" name="ppn_ditangguhkan" placeholder=""/>
												</td>
												<td>
													<input type="text" class="form-control form-control-sm input-mask" data-inputmask="'alias': 'currency', 'prefix': ''" name="ppn_dibebaskan" placeholder=""/>
												</td>
												<td>
													<input type="text" class="form-control form-control-sm input-mask" data-inputmask="'alias': 'currency', 'prefix': ''" name="ppn_tidak_dipungut" placeholder=""/>
												</td>
											</tr>
											<tr>
												<td>PPnBM</td>
												<td>
													<input type="text" class="form-control form-control-sm input-mask" data-inputmask="'alias': 'currency', 'prefix': ''" name="ppnbm_ditangguhkan" placeholder=""/>
												</td>
												<td>
													<input type="text" class="form-control form-control-sm input-mask" data-inputmask="'alias': 'currency', 'prefix': ''" name="ppnbm_dibebaskan" placeholder=""/>
												</td>
												<td>
													<input type="text" class="form-control form-control-sm input-mask" data-inputmask="'alias': 'currency', 'prefix': ''" name="ppnbm_tidak_dipungut" placeholder=""/>
												</td>
											</tr>
											<tr>
												<td>PPH</td>
												<td>
													<input type="text" class="form-control form-control-sm input-mask" data-inputmask="'alias': 'currency', 'prefix': ''" name="pph_ditangguhkan" placeholder=""/>
												</td>
												<td>
													<input type="text" class="form-control form-control-sm input-mask" data-inputmask="'alias': 'currency', 'prefix': ''" name="pph_dibebaskan" placeholder=""/>
												</td>
												<td>
													<input type="text" class="form-control form-control-sm input-mask" data-inputmask="'alias': 'currency', 'prefix': ''" name="pph_tidak_dipungut" placeholder=""/>
												</td>
											</tr>
											<tr>
												<td>TOTAL</td>
												<td>
													<input type="text" class="form-control form-control-sm input-mask" data-inputmask="'alias': 'currency', 'prefix': ''" name="total_ditangguhkan" placeholder=""/>
												</td>
												<td>
													<input type="text" class="form-control form-control-sm input-mask" data-inputmask="'alias': 'currency', 'prefix': ''" name="total_dibebaskan" placeholder=""/>
												</td>
												<td>
													<input type="text" class="form-control form-control-sm input-mask" data-inputmask="'alias': 'currency', 'prefix': ''" name="total_tidak_dipungut" placeholder=""/>
												</td>
											</tr>
											</tbody>
										</table>
