...
<div class="card-body">
	...
	<div class="" id="30"
		style="margin-top: 15px; padding-top: 15px;  border-style: dotted; border-width:1px; display: block;">
				...
				<table class="table table-sm table-bordered" style="table-layout: fixed">
					<tbody>
						...
						<tr>
							...
							<td>
								<input type="text" class="form-control form-control-sm x-readonly input-mask"
									...
									name="tpb_pungutan[0][NILAI_PUNGUTAN]" im-insert="true" style="text-align: right;">
							...
							<td>
								<input type="text" class="form-control form-control-sm x-readonly input-mask"
									...
									name="tpb_pungutan[1][NILAI_PUNGUTAN]" im-insert="true" style="text-align: right;">
							...
							<td>
								<input type="text" class="form-control form-control-sm x-readonly input-mask"
									...
									name="tpb_pungutan[2][NILAI_PUNGUTAN]" im-insert="true" style="text-align: right;">
						...
						<tr>
							...
							<td>
								<input type="text" class="form-control form-control-sm x-readonly input-mask"
									...
									name="tpb_pungutan[3][NILAI_PUNGUTAN]" im-insert="true" style="text-align: right;">
							...
							<td>
								<input type="text" class="form-control form-control-sm x-readonly input-mask"
									...
									name="tpb_pungutan[4][NILAI_PUNGUTAN]" im-insert="true" style="text-align: right;">
							...
							<td>
								<input type="text" class="form-control form-control-sm x-readonly input-mask"
									...
									name="tpb_pungutan[5][NILAI_PUNGUTAN]" im-insert="true" style="text-align: right;">
						...
						<tr>
							...
							<td>
								<input type="text" class="form-control form-control-sm x-readonly input-mask"
									...
									name="tpb_pungutan[6][NILAI_PUNGUTAN]" im-insert="true" style="text-align: right;">
							...
							<td>
								<input type="text" class="form-control form-control-sm x-readonly input-mask"
									...
									name="tpb_pungutan[7][NILAI_PUNGUTAN]" im-insert="true" style="text-align: right;">
							...
							<td>
								<input type="text" class="form-control form-control-sm x-readonly input-mask"
									...
									name="tpb_pungutan[8][NILAI_PUNGUTAN]" im-insert="true" style="text-align: right;">
						...
						<tr>
							...
							<td>
								<input type="text" class="form-control form-control-sm x-readonly input-mask"
									...
									name="tpb_pungutan[9][NILAI_PUNGUTAN]" im-insert="true" style="text-align: right;">
							...
							<td>
								<input type="text" class="form-control form-control-sm x-readonly input-mask"
									...
									name="tpb_pungutan[10][NILAI_PUNGUTAN]" im-insert="true" style="text-align: right;">
							...
							<td>
								<input type="text" class="form-control form-control-sm x-readonly input-mask"
									...
									name="tpb_pungutan[11][NILAI_PUNGUTAN]" im-insert="true" style="text-align: right;">
						...
						<tr>
							...
							<td>
								<input type="text" class="form-control form-control-sm x-readonly input-mask"
									...
									name="tpb_pungutan[12][NILAI_PUNGUTAN]" im-insert="true" style="text-align: right;">
							...
							<td>
								<input type="text" class="form-control form-control-sm x-readonly input-mask"
									...
									name="tpb_pungutan[13][NILAI_PUNGUTAN]" im-insert="true" style="text-align: right;">
							...
							<td>
								<input type="text" class="form-control form-control-sm x-readonly input-mask"
									...
									name="tpb_pungutan[14][NILAI_PUNGUTAN]" im-insert="true" style="text-align: right;">
						...
						<tr>
							...
							<td>
								<input type="text" class="form-control form-control-sm x-readonly input-mask"
									...
									name="tpb_pungutan[15][NILAI_PUNGUTAN]" im-insert="true" style="text-align: right;">
							...
							<td>
								<input type="text" class="form-control form-control-sm x-readonly input-mask"
									...
									name="tpb_pungutan[16][NILAI_PUNGUTAN]" im-insert="true" style="text-align: right;">
							...
							<td>
								<input type="text" class="form-control form-control-sm x-readonly input-mask"
									...
									name="tpb_pungutan[17][NILAI_PUNGUTAN]" im-insert="true" style="text-align: right;">
						...
						<tr>
							...
							<td><input type="text" class="form-control form-control-sm total_tangguh input-mask"
									data-inputmask="'alias': 'currency', 'prefix': ''" id="total_tangguh"
									name="tpb_header[TOTAL_TANGGUH]" im-insert="true" style="text-align: right;"></td>
							<td><input type="text" class="form-control form-control-sm total_bebas input-mask"
									data-inputmask="'alias': 'currency', 'prefix': ''" id="total_bebas"
									name="tpb_header[TOTAL_BEBAS]" im-insert="true" style="text-align: right;"></td>
							<td><input type="text" class="form-control form-control-sm total_tidak input-mask"
									data-inputmask="'alias': 'currency', 'prefix': ''" id="total_tidak"
									name="tpb_header[TOTAL_TIDAK_DIPUNGUT]" im-insert="true" placeholder="0.00"
									...
									<div class="row" style="margin-top: 15px;">
										...
										<div class="col-sm-12 col-lg-12 col-xl-12"
											...
											<dl class="row" style="margin-top: 15px;">
												...
												<dd class="col-sm-3"><input type="text"
														value="<?=placeValue($tpbHeader,'KATEGORI_BARANG')?>"
														class="form-control form-control-sm " readOnly></dd>
										...
										<div class="col-sm-12 col-lg-12 col-xl-12"
											...
											<dl class="row" style="margin-top: 15px;">
												...
												<dd class="col-sm-2"><input type="text"
														value="<?=placeValue($tpbHeader,'KODE_BARANG')?>"
														class="form-control form-control-sm " readOnly></dd>
												<dt class="col-sm-2">Nomor HS</dt>
												<dd class="col-sm-2"><input type="text"
														value="<?=placeValue($tpbHeader,'POS_TARIF')?>"
														class="form-control form-control-sm " readOnly> </dd>
												...
												<dd class="col-sm-9"> <input type="text"
														value="<?=placeValue($tpbHeader,'URAIAN')?>"
														class="form-control form-control-sm " readOnly></dd>
												<dt class="col-sm-2">Tipe</dt>
												<dd class="col-sm-2"><input type="text"
														value="<?=placeValue($tpbHeader,'TIPE')?>"
														class="form-control form-control-sm " readOnly></dd>

												<dt class="col-sm-2">Ukuran</dt>
												<dd class="col-sm-2"><input type="text"
														value="<?=placeValue($tpbHeader,'UKURAN')?>"
														class="form-control form-control-sm " readOnly></dd>
												<dt class="col-sm-2">Spf Lain</dt>
												<dd class="col-sm-2"><input type="text"
														value="<?=placeValue($tpbHeader,'SPESIFIKASI_LAIN')?>"
														class="form-control form-control-sm " readOnly></dd>
												<dt class="col-sm-2">Merk</dt>
												<dd class="col-sm-2"><input type="text"
														value="<?=placeValue($tpbHeader,'MERK')?>"
														class="form-control form-control-sm " readOnly> </dd>
										...
										<div class="col-sm-12 col-lg-12 col-xl-12"
											...
											<dl class="row" style="margin-top: 15px;">
												...
												<dd class="col-sm-2"><input type="text"
														value="<?=placeValue($tpbHeader,'JUMLAH_SATUAN')?>"
														class="form-control form-control-sm " readOnly> </dd>
												...
												<dd class="col-sm-2"><input type="text"
														value="<?=placeValue($tpbHeader,'CIF')?>"
														class="form-control form-control-sm " readOnly></dd>
												<dt class="col-sm-2">Jenis Satuan</dt>
												<dd class="col-sm-2"><input type="text"
														value="<?=placeValue($tpbHeader,'KODE_SATUAN')?>"
														class="form-control form-control-sm " readOnly></dd>
												...
												<dd class="col-sm-2"> <input type="text"
														value="<?=placeValue($tpbHeader,'CIF_RUPIAH')?>"
														class="form-control form-control-sm "
														readOnly><?=placeValue($barang,'')?></dd>
												<dt class="col-sm-2">Netto (Kgm)</dt>
												<dd class="col-sm-2"><input type="text"
														value="<?=placeValue($tpbHeader,'NETTO')?>"
														class="form-control form-control-sm " readOnly></dd>

												<dt class="col-sm-2">Volume (M3)</dt>
												<dd class="col-sm-2"><input type="text"
														value="<?=placeValue($tpbHeader,'VOLUMEN')?>"
														class="form-control form-control-sm " readOnly> </dd>


												<dt class="col-sm-2">Harga Penyerahan Rp</dt>
												<dd class="col-sm-2"><input type="text"
														value="<?=placeValue($tpbHeader,'HARGA_PENYERAHAN')?>"
														class="form-control form-control-sm " readOnly></dd>
									...
									<div class="row" style="margin-top: 15px;">
										...
										<div class="col-sm-12 col-lg-12 col-xl-12">
											<dl class="row"
												...
												<dd class="col-sm-2"><input type="text"
														value="<?=placeValue($tpbBb,'SERI_BARANG')?>"
														class="form-control form-control-sm " readOnly> </dd>
												<dt class="col-sm-2">Bahan Baku Ke</dt>
												<dd class="col-sm-2"><input type="text"
														value="<?=placeValue($tpbBb,'SERI_BAHAN_BAKU')?>  "
														class="form-control form-control-sm " readOnly> </dd>
										...
										<div class="col-sm-12 col-lg-12 col-xl-12"
											...
											<dl class="row" style="margin-top: 15px;">
												...
												<dt class="col-sm-2">Kode</dt>
												<dd class="col-sm-2"><input type="text"
														value="<?=placeValue($tpbBb,'KODE_BARANG')?>"
														class="form-control form-control-sm " readOnly> </dd>
												<dt class="col-sm-2">Nomor HS</dt>
												<dd class="col-sm-2"><input type="text"
														value="<?=placeValue($tpbBb,'POS_TARIF')?>"
														class="form-control form-control-sm " readOnly></dd>
												<dt class="col-sm-2"></dt>
												<dd class="col-sm-2"></dd>
												<dt class="col-sm-2">Uraian Barang</dt>
												<dd class="col-sm-10"><input type="text"
														value="<?=placeValue($tpbBb,'URAIAN')?>"
														class="form-control form-control-sm " readOnly> </dd>
												<dt class="col-sm-2">Tipe</dt>
												<dd class="col-sm-1"><input type="text"
														value="<?=placeValue($tpbBb,'TIPE')?>"
														class="form-control form-control-sm " readOnly></dd>
												...
												<dt class="col-sm-2">Spf Lain</dt>
												<dd class="col-sm-1"><input type="text"
														value="<?=placeValue($tpbBb,'SPESIFIKASI_LAIN')?>"
														class="form-control form-control-sm " readOnly></dd>
												<dt class="col-sm-2">Merk</dt>
												<dd class="col-sm-1"><input type="text"
														value="<?=placeValue($tpbBb,'MERK')?>"
														class="form-control form-control-sm " readOnly></dd>
										...
										<div class="col-sm-12 col-lg-12 col-xl-12">
											<dl class="row"
												...
												<dt class="col-sm-2">CIF Rupiah</dt>
												<dd class="col-sm-2"><input type="text"
														value="<?=placeValue($tpbBb,'CIF_RUPIAH')?>"
														class="form-control form-control-sm " readOnly> </dd>

												<dt class="col-sm-2">Jumlah Satuan</dt>
												<dd class="col-sm-2"><input type="text"
														value="<?=placeValue($tpbBb,'JUMLAH_SATUAN')?>"
														class="form-control form-control-sm " readOnly> </dd>
												<dt class="col-sm-2">Satuan</dt>
												<dd class="col-sm-2"><input type="text"
														value="<?=placeValue($tpbBb,'JENIS_SATUAN')?>"
														class="form-control form-control-sm " readOnly> </dd>
									...
									<div class="row" style="margin-top: 15px;">
										...
										<div class="col-sm-12 col-lg-12 col-xl-12">
											<dl class="row"
												...
												<dt class="col-sm-3">Detail Ke </dt>
												<dd class="col-sm-1"> <input type="text"
														value="<?=placeValue($barang,'SERI_BARANG')?>  "
														class="form-control form-control-sm " readOnly></dd>
												<dt class="col-sm-1">Dari</dt>
												<dd class="col-sm-1"> <input type="text"
														value="<?=placeValue($barang,'SERI_BAHAN_BAKU')?>"
														class="form-control form-control-sm " readOnly> </dd>
												...
												<dd class="col-sm-1"><input type="text"
														value="<?=placeValue($barang,'NOMOR_DAFTAR_DOK_ASAL')?>"
														class="form-control form-control-sm " readOnly>
												</dd>
												<dt class="">/</dt>
												<dd class="col-sm-2"><input type="text"
														value="<?=placeValue($barang,'TANGGAL_DAFTAR_DOK_ASAL')?>"
														class="form-control form-control-sm " readOnly>
												</dd>

												<dt class="col-sm-3">No Aju</dt>
												<dd class="col-sm-2"><input type="text"
														value="<?=placeValue($barang,'NOMOR_AJU_DOK_ASAL')?>"
														class="form-control form-control-sm " readOnly> <b>Urut Ke</b>
													<input type="text"
										...
										<div class="col-sm-12 col-lg-12 col-xl-12">
											...
											<dl class="row"
												...
												<dd class="col-sm-2"> <input type="text"
														value="<?=placeValue($barang,'SERIKODE_BARANG_BARANG')?>"
														class="form-control form-control-sm " readOnly> </dd>
												<dt class="col-sm-3">Nomor HS</dt>
												<dd class="col-sm-2"> <input type="text"
														value="<?=placeValue($barang,'POS_TARIF')?>"
														class="form-control form-control-sm " readOnly></dd>
												<dt class="col-sm-0"></dt>
												<dd class="col-sm-2"> </dd>
												<dt class="col-sm-3">Uraian Barang</dt>
												<dd class="col-sm-9"> <input type="text"
														value="<?=placeValue($barang,'URAIAN')?>"
														class="form-control form-control-sm " readOnly></dd>
												<dt class="col-sm-3">Tipe</dt>
												<dd class="col-sm-2"> <input type="text"
														value="<?=placeValue($barang,'TIPE')?>"
														class="form-control form-control-sm " readOnly></dd>
												<dt class="col-sm-1">Ukuran</dt>
												<dd class="col-sm-2"> <input type="text"
														value="<?=placeValue($barang,'UKURAN')?>"
														class="form-control form-control-sm " readOnly> </dd>
												<dt class="col-sm-1">Spf Lain</dt>
												<dd class="col-sm-2"> <input type="text"
														value="<?=placeValue($barang,'SPESIFIKASI_LAIN')?>"
														class="form-control form-control-sm " readOnly></dd>
												<dt class="col-sm-3">Merk</dt>
												<dd class="col-sm-2"> <input type="text"
														value="<?=placeValue($barang,'MERK')?>"
														class="form-control form-control-sm " readOnly> </dd>
										...
										<div class="col-sm-12 col-lg-12 col-xl-12">
											<dl class="row"
												...
												<dd class="col-sm-3"><input type="text"
														value="<?=placeValue($barang,'CIF_RUPIAH')?>"
														class="form-control form-control-sm " readOnly></dd>
												<dt class="col-sm-3">Jumlah Satuan</dt>
												<dd class="col-sm-3"><input type="text"
												...
												<dd class="col-sm-3"><input type="text"
														value="<?=placeValue($barang,'JENIS_SATUAN')?>"
														class="form-control form-control-sm " readOnly></dd>
												<dt class="col-sm-3">Netto</dt>
												<dd class="col-sm-3"> <input type="text"
														value="<?=placeValue($barang,'NETTO')?>"
														class="form-control form-control-sm " readOnly></dd>
											</dl>
										</div>
									</div>
