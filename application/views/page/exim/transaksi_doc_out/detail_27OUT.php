	...
	<div class="row">
		<div class="col-sm-12 col-lg-6 col-xl-6">
			<dl class="row" style="margin-top: 15px;">
		        ...
		        <dd class="col-sm-8"><?=placeValue($tpbHeader,'NOMOR_AJU')?></dd>
		        <dt class="col-sm-4">Tanggal Pengajuan</dt>
		        <dd class="col-sm-8"><?=isset($tpbHeader->TANGGAL_AJU) ? date('d-m-Y',strtotime($tpbHeader->TANGGAL_AJU)) : ''?></dd>
		        <dt class="col-sm-4">Jenis TPB</dt>
		        <dd class="col-sm-8"><?=placeValue($tpbHeader,'URAIAN_JENIS_TPB')?></dd>
		        <dt class="col-sm-4">Jenis Dokumen</dt>
		        <dd class="col-sm-8"><?=placeValue($tpbHeader,'URAIAN_DOKUMEN_PABEAN')?></dd>
		    </dl>
		</div>
		<div class="col-sm-12 col-lg-6 col-xl-6">
			<dl class="row" style="margin-top: 15px;">
		        <dt class="col-sm-4">No Pendaftaran</dt>
		        <dd class="col-sm-8"><?=placeValue($tpbHeader,'NOMOR_DAFTAR')?></dd>
		        <dt class="col-sm-4">Tanggal Pendaftaran</dt>
		        <dd class="col-sm-8"><?=isset($tpbHeader->TANGGAL_DAFTAR) ? date('d-m-Y',strtotime($tpbHeader->TANGGAL_DAFTAR)) : ''?></dd>
		    </dl>
		</div>
		<div class="col-sm-12 col-lg-6 col-xl-6">
			<dl class="row" style="margin-top: 15px;">
		        ...
		        <dd class="col-sm-8"><?=placeValue($tpbHeader,'NAMA_PENERIMA_BARANG')?></dd>
		        <dt class="col-sm-4">Alamat</dt>
		        <dd class="col-sm-8"><?=placeValue($tpbHeader,'ALAMAT_PENERIMA_BARANG')?></dd>
		    </dl>
		</div>
		<div class="col-sm-12 col-lg-6 col-xl-6">
			<dl class="row" style="margin-top: 15px;">
				<dt class="col-sm-4">PENGUSAHA</dt>
		        <dd class="col-sm-8"></dd>
		        <dt class="col-sm-4">NPWP</dt>
		        <dd class="col-sm-8"><?=placeValue($tpbHeader,'ID_PENGUSAHA')?></dd>
		        <dt class="col-sm-4">Nama</dt>
		        <dd class="col-sm-8"><?=placeValue($tpbHeader,'NAMA_PENGUSAHA')?></dd>
		        <dt class="col-sm-4">Alamat</dt>
		        <dd class="col-sm-8"><?=placeValue($tpbHeader,'ALAMAT_PENGUSAHA')?></dd>
		        <dt class="col-sm-4">No. Ijin TPB</dt>
		        <dd class="col-sm-8"><?=placeValue($tpbHeader,'NOMOR_IJIN_TPB')?></dd>
		    </dl>
		</div>
	</div>
	<hr>
