<div class="x-hidden dokumen_template include-262">
	<div class="form-group row">
		<div class="col-md-12">
			...
			<div class="table-responsive">
				<table class="table table-hover table-bordered table-striped table-sm dt_" id="table_detail_262" role="grid">
					<thead>
					<tr>
					...
					<tbody>
						<tr>
							<td>
								<select class="form-control form-control-sm mselect2" name="tpb_jaminan[KODE_JENIS_JAMINAN]">
							...
							<td>
								<div class="input-group input-group-sm">
									<input type="text" class="form-control form-control-sm 261_nodoc" name="tpb_dokumen[2][NOMOR_DOKUMEN]" placeholder=""/>
									...
									<div class="input-group-append">
										<button type="button" class="btn btn-default" data-toggle="modal" data-target="#bc_261_modal"><i class="fal fa-search"></i></button>
									</div>
								</div>
							</td>
						</tr>
	...
	<div class="form-group row">
		<div class="col-md-12">
			...
			<div class="table-responsive">
				<table class="table table-hover table-bordered table-striped table-sm dt_inv_add" id="dt_referensi_261" style="white-space: nowrap">
					<thead>
					<tr>
