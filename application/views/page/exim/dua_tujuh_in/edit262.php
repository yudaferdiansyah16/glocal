	...
	<div class="row">
		...
		<div class="col-sm_12 col-lg-12 col-xl-12">
			<div class="row">
				...
				<div class="col-sm-12 col-lg-6 col-xl-6">
					<p><b>Tujuan Pemasukan</b> : <?=placeValue($tpbHeader,'URAIAN_JENIS_TPB')?></p>
				</div>
				</div>
				</div>
		<div class="col-sm-12 col-lg-6 col-xl-6">
		...
		<div class="col-sm-12 col-lg-12 col-xl-12">
			<div class="row">
				<div class="col-sm-12 col-lg-6 col-xl-6">
					<p style="margin: 0;padding: 0"><b>PENGUSAHA TPB</b></p>
					...
					<p ><b>Ijin TPB</b> : <?=placeValue($tpbHeader,'NOMOR_IJIN_TPB')?></p>
					<p ><b>Api</b> : <?=placeValue($tpbHeader,'NOMOR_IJIN_TPB')?></p>
				</div>
				<div class="col-sm-12 col-lg-6 col-xl-6">
					<p style="margin: 0;padding: 0"><b>PENGIRIMAN BARANG</b></p>
					<p style="margin: 0;padding: 0"><b>NPWP</b> : <?=placeValue($tpbHeader,'ID_PENGUSAHA')?></p>
					<p style="margin: 0;padding: 0"><b>Nama</b> : <?=placeValue($tpbHeader,'NAMA_PENGUSAHA')?></p>
					<p style="margin: 0;padding: 0"><b>Alamat</b> : <?=placeValue($tpbHeader,'ALAMAT_PENGUSAHA')?></p>
				...
				<div class="col-sm-12 col-lg-6 col-xl-6">
					...
					<p ><b>Jenis Sarana Pengangkut Darat</b> : <?=placeValue($tpbHeader,'ID_PENGUSAHA')?></p>
			...
			<div class="col-sm-12 col-lg-12 col-xl-12">
				...
				<div class="col-sm-6 col-lg-3 col-xl-3">
					<p style="margin: 0;padding: 0"><b>Jenis Pungutan</b></p>
					<p style="margin: 0;padding: 0"><b>BM</b> : <?=placeValue($tpbHeader,'ID_PENGUSAHA')?></p>
					<p style="margin: 0;paddiPng: 0"><b>BMT </b> : <?=placeValue($tpbHeader,'NAMA_PENGUSAHA')?></p>
					<p style="margin: 0;padding: 0"><b>Cukai</b> : <?=placeValue($tpbHeader,'ALAMAT_PENGUSAHA')?></p>
					<p style="margin: 0;padding: 0"><b>PPN</b> : <?=placeValue($tpbHeader,'ALAMAT_PENGUSAHA')?></p>
					<p style="margin: 0;padding: 0"><b>PPnBM</b> : <?=placeValue($tpbHeader,'ALAMAT_PENGUSAHA')?></p>
					<p style="margin: 0;padding: 0"><b>PPh</b> : <?=placeValue($tpbHeader,'ALAMAT_PENGUSAHA')?></p>
					<p style="margin: 0;padding: 0"><b>Jumlah Total</b> : <?=placeValue($tpbHeader,'ALAMAT_PENGUSAHA')?></p>
				</div>
				<div class="col-sm-12 col-lg-6 col-xl-6">
					<p style="margin: 0;padding: 0"><b>Ditangguhkan</b></p>
					<p style="margin: 0;padding: 0"><b>Volume (m3)</b> : <?=placeValue($tpbHeader,'ID_PENGUSAHA')?></p>
					<p style="margin: 0;padding: 0"><b>Berat Kotor (Kg)</b> : <?=placeValue($tpbHeader,'NAMA_PENGUSAHA')?></p>
					<p style="margin: 0;padding: 0"><b>Berat Bersih (Kg)</b> : <?=placeValue($tpbHeader,'ALAMAT_PENGUSAHA')?></p>
					<p style="margin: 0;padding: 0"><b>Jumlah Barang (Kg)</b> : <?=placeValue($tpbHeader,'ALAMAT_PENGUSAHA')?></p>
			...
			<div class="table-responsive">
				...
				<table class="table table-hover table-bordered table-striped table-sm" id="dt_doc_in_detail" role="grid" style="white-space: nowrap;width: 99%">
					...
					<tr>
						...
						<th class="text-center">Pinjam In</th>
