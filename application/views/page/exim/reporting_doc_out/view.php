<main id="js-page-content" role="main" class="page-content">
	<ol class="breadcrumb page-breadcrumb">
		...
		<li class="breadcrumb-item active">Reporting Doc Out</li>
			...
			<div class="card mb-g">
				<div class="card-header">
					<div class="row">
						...
						<div class="col-sm-12 col-lg-2">
							<label class="form-label">Stufffing Date</label>
							<div class="input-group input-group-sm">
								<input type="text" class="form-control form-control-sm x-datepicker x-readonly tglstuffingawal" readonly placeholder="Select date" onchange="reloadDT('tglstuffingawal')" />
								<div class="input-group-append">
									<button class="tglstuffingawalclose btn btn-sm btn-default x-hidden" onclick="removeFilter('tglstuffingawal')">
										<i class="text-danger fal fa-times"></i>
									</button>
									<button class="tglstuffingawalcal btn btn-sm btn-default">
										<i class="fa fal fa-calendar"></i>
									</button>
								</div>
							</div>
						...
						<div class="col-sm-12 col-lg-2">
							<label class="form-label">&nbsp;</label>
							<div class="input-group input-group-sm">
								<input type="text" class="form-control form-control-sm x-datepicker x-readonly tglstuffingakhir" readonly placeholder="Select date" onchange="reloadDT('tglstuffingakhir')" />
								<div class="input-group-append">
									<button class="tglstuffingakhirclose btn btn-sm btn-default x-hidden" onclick="removeFilter('tglstuffingakhir')">
										<i class="text-danger fal fa-times"></i>
									</button>
									<button class="tglstuffingakhircal btn btn-sm btn-default">
										<i class="fa fal fa-calendar"></i>
									</button>
								</div>
							</div>
					...
					<div class="form-group row">
						<div class="col-md-12">
							<div class="table-responsive">
								<table class="table table-sm table-bordered table-striped table-hover nowrap" id="dt" width="99%">
									<thead>
									<tr>
										<th class="text-center" rowspan="2">No.</th>
										<th class="text-center" rowspan="2">Document Type</th>
										<th class="text-center" colspan="2">Submission</th>
										<th class="text-center" colspan="2">Stuffing</th>
