			...
			<div class="card mb-g">
				<div class="card-body">
					<form method="post" action="<?= base_url('exim/transaksi_doc_in/store') ?>">
						<div class="form-group row">
							<div class="col-sm-12 col-lg-12 col-xl-12">
								<div class="row">
									...
									<div class="col-sm-12 col-lg-4 col-xl-4 x-hidden dokumen_template include-40 include-262 ">
										<label class="form-label">
												Tujuan Pengiriman
											</label>
									...
									<div class="col-sm-12 col-lg-4 col-xl-4 x-hidden dokumen_template include-23 include-262">
										<label class="form-label">
											Tujuan TPB
										</label>
							...
							<div class="col-sm-12 col-lg-6 col-xl-6">
								...
								<div class="input-group input-group-sm">
									<input type="text" class="form-control form-control-sm x-readonly nama_supplier_filter" readonly placrholder/>
									<input type="hidden" class="form-control form-control-sm id_supplier_filter" name="id_supplier" placeholder=""/>
									<div class="input-group-append">
							...
							<div class="col-sm-12 col-lg-12 col-xl-12">
								<div class="row">
									...
									<div class="col-sm-12 col-lg-3 col-xl-3">
										...
										<input type="text" name="tpb_header[VOLUME]" class="form-control form-control-sm input-mask volume" data-inputmask="'alias': 'currency', 'prefix': ''" >
									</div>
									<div class="col-sm-12 col-lg-3 col-xl-3">
										<label class="form-label">NETTO</label>
										<input type="text" name="tpb_header[NETTO]" class="form-control form-control-sm input-mask netto" data-inputmask="'alias': 'currency', 'prefix': ''" >
									</div>
									<div class="col-sm-12 col-lg-3 col-xl-3">
									...
									<div class="col-sm-12 col-lg-3 col-xl-3">
										...
										<input type="text"class="form-control form-control-sm nama_pengangkut"    name="tpb_header[NAMA_PENGANGKUTAN]" value="	" >
									</div>
									<div class="col-sm-12 col-lg-3 col-xl-3 dokumen_template x-hidden include-40 include-27IN">
										<label class="form-label">Nomor Polisi</label>
										<input type="text" class="form-control form-control-sm plat_kendaraan" name="tpb_header[NOMOR_POLISI]"/>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="col-md-12">
								...
								<table class="table table-hover table-bordered table-striped table-sm dt_po_add" id="dt_doc_in_add" style="white-space: nowrap;">
										...
										<tr>
											...
											<th class="text-center x-hidden include-23 include-262 dokumen_template">Satuan</th>
											<th class="text-center">qty</th>
											<!-- <th class="text-center dokumen_template x-hidden include-23">Seri Barang</th>
											<th class="text-center dokumen_template x-hidden include-23">Harga Satuan</th>
											<th class="text-center dokumen_template x-hidden include-23 include-262">Harga Invoice</th>
											...
											<th class="text-center x-hidden include-23 include-262 dokumen_template">Seri Barang</th>
											<th class="text-center">Netto</th>
											<th class="text-center">Harga Penyerahan</th>
											<th class="text-center x-hidden include-23 include-262 dokumen_template">Harga Satuan</th>
											<th class="text-center x-hidden include-23 include-262 dokumen_template">Harga Invoice</th>
											<th class="text-center x-hidden include-23 include-262 dokumen_template">Kode Skema Tarif</th>
											<th class="text-center x-hidden include-23 include-262 dokumen_template">Post Tarif</th>
						...
						<!-- <div class="form-group row x-hidden include-40 dokumen_template">
							<div class="col-md-12">
								<label><b>Barang</b></label>
								<div class="table-responsive">
									<table class="table table-hover table-bordered table-striped table-sm dt_po_add" id="dt_doc_in_add" style="white-space: nowrap;">
										...
										<tr>
											...
											<th class="text-center dokumen_template x-hidden include-40 include-27IN"><?=addSpace(5)?>Harga Penyerahan<?=addSpace(5)?></th>
											<th class="text-center"><?=addSpace(15)?>Netto<?=addSpace(15)?></th>
											<th class="text-center"><?=addSpace(15)?>Asuransi<?=addSpace(15)?></th>
											<th class="text-center"><?=addSpace(15)?>Diskon<?=addSpace(15)?></th>
											<th class="text-center"><?=addSpace(15)?>Kemasan<?=addSpace(15)?></th>
											<th class="text-center x-hidden include-23 dokumen_template">Tarif</th>
										</tr>
										</thead>
										<tbody>
...
<table class="x-hidden" id="table-template">
	...
	<tr data-index="x">
		...
		<td>
			<p class="text_kode_barang" style="margin: 0;padding: 0"></p>
		</td>
		<td>
		...
		<td class="text-right x-hidden include-23 include-262 dokumen_template">
			...
			<!-- <input type="hidden" class="uraian_satuan" name="tpb_barang[x][URAIAN_SATUAN]"/> -->
		</td>
		<td class="text-right">
		...
		<td class="text-right x-hidden">
			<p class="text_seri_barang" style="margin: 0;padding: 0"></p>
			<input type="hidden" class="kode_barang" name="tpb_barang[x][KODE_BARANG]"/>
			<input type="hidden" class="nama_barang" name="tpb_barang[x][URAIAN]"/>
			<input type="hidden" class="seri_barang" name="tpb_barang[x][SERI_BARANG]"/>
			<input type="hidden" class="id_detail_dn" name="tpb_barang[x][id_detail_dn]"/>
		...
		<td>
			<input type="text" class="form-control form-control-sm input-mask " data-inputmask="'alias': 'currency', 'prefix': ''"  name="tpb_barang[x][NETTO]" style="width: 100px;" size="1000"/>
		...
		<td class=" x-hidden include-23 include-262 dokumen_template">
			<input type="text" class="form-control form-control-sm harga_satuan x-readonly input-mask x-hidden include-23 include-262 dokumen_template"  data-inputmask="'alias': 'currency', 'prefix': ''"  readonly name="tpb_barang[x][HARGA_SATUAN]" size="2000"/>
		</td>
		<td class="x-hidden include-23 dokumen_template">
			<input type="text" class="form-control form-control-sm harga_invoice x-readonly input-mask x-hidden include-23 include-262 dokumen_template" data-inputmask="'alias': 'currency', 'prefix': ''" name="tpb_barang[x][HARGA_INVOICE]" readonly size="2000"  />
		</td>

		<td class="x-hidden include-23 include-262 dokumen_template">
			<select class="form-control form-control-sm mselect2 x-hidden include-23 include-262 dokumen_template" name="tpb_barang[x][KODE_SKEMA_TARIF]">
				<option value="" disabled selected>Select Data . . .</option>
				<?= createOption($sskema_tarif, 'KODE_SKEMA', array('URAIAN_SKEMA'), ' - ') ?>
			</select>
		</td>
		<td class=" dokumen_template x-hidden include-23 include-262">
			<input type="text" class="form-control form-control-sm harga_invoice x-readonly input-mask x-hidden include-23 include-262 dokumen_template" data-inputmask="'alias': 'currency', 'prefix': ''" readonly name="tpb_barang[x][HARGA_INVOICE]" id="tpb_barang[x][HARGA_INVOICE]" size="2000"/>
			<input type="hidden" class="fob_barang x-hidden" name="tpb_barang[x][FOB]"/>
			<input type="hidden" class="cif_barang x-hidden" name="tpb_barang[x][CIF]"/>
		</td>
		<td class=" dokumen_template x-hidden ">
		...
		<td class="x-hidden dokumen_template">
			<input type="text" name="tpb_barang[x][JUMLAH_KEMASAN]" class="form-control form-control-sm input-mask x-hidden include-23 dokumen_template" data-inputmask="'alias': 'currency', 'prefix': ''" size="1000">
		</td>
		<td class="x-hidden dokumen_template include-12">
			<div class="input-group input-group-sm">
		...
		<td class="x-hidden dokumen_template include-23 include-262">
			<div class="input-group input-group-sm">
				<div class="input-group-append">
	...
	<tr data-index="x">
		...
		<td>
			<div class="input-group input-group-sm">
				...
				<input type="hidden" class="form-control form-control-sm" id="kode_kemasan[x]" name="tpb_barang[x][KODE_KEMASAN]" />
				<div class="input-group-append">
