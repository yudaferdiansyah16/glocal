				...
				<div class="modal-body">
					...
					<div class="col-sm-12 col-lg-12 col-xl-12">
						<dl class="row"
							...
							<dd class="col-sm-3">
								<input type="text" id="no_barang" class="form-control form-control-sm " readOnly>
							</dd>
							...
							<dd class="col-sm-3">
								<input type="text" id="uraian" class="form-control form-control-sm " readOnly>
							</dd>
							<dt class="col-sm-3">Merk</dt>
							<dd class="col-sm-3">
								<input type="text" id="merk" class="form-control form-control-sm " readOnly>
							</dd>
							<dt class="col-sm-3">Hs</dt>
							<dd class="col-sm-3">
								<input type="text" id="hs" class="form-control form-control-sm " readOnly>
							</dd>
							<dt class="col-sm-3">Tipe</dt>
							<dd class="col-sm-3">
								<input type="text" id="tipe" class="form-control form-control-sm " readOnly>
							</dd>
							<dt class="col-sm-3">Ukuran</dt>
							<dd class="col-sm-3">
								<input type="text" id="ukuran" class="form-control form-control-sm " readOnly>
							</dd>
							<dt class="col-sm-3">Spf Lain</dt>
							<dd class="col-sm-3">
								<input type="text" id="spf_lain" class="form-control form-control-sm " readOnly>
							</dd>
						</dl>
					</div>
					<div class="col-sm-12 col-lg-12 col-xl-12">
						...
						<dl class="row"
							...
							<dd class="col-sm-3">
								<input type="text" id="jumlah_satuan" 	class="form-control form-control-sm " readOnly>
							</dd>
							<dt class="col-sm-3">Jenis Satuan</dt>
							<dd class="col-sm-3">
								<input type="text" id="jenis_satuan" 	class="form-control form-control-sm " readOnly>
							</dd>
							<dt class="col-sm-3">Netto(Kgm)</dt>
							<dd class="col-sm-3">
								<input type="text" id="netto" 	class="form-control form-control-sm " readOnly>
							</dd>
							<dt class="col-sm-3">Volume(m3)</dt>
							<dd class="col-sm-3">
								<input type="text" id="volume" 	class="form-control form-control-sm " readOnly>
							</dd>
							<dt class="col-sm-3">Harga Penyerahan Rp</dt>
							<dd class="col-sm-3">
								<input type="text" id="harga_penyerahan" 	class="form-control form-control-sm " readOnly>
							</dd>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="col-sm-12 col-lg-12 col-xl-12">
					...
					<dd class="col-sm-3">
						<input type="text" id="kode_dok" name="kode_dok" 	class="form-control form-control-sm " readOnly>
					</dd>
					<dt class="col-sm-3">Nomor</dt>
					<dd class="col-sm-3">
						<input type="text" id="nomor_dok" name="nomor_dok" 	class="form-control form-control-sm " readOnly>
					</dd>
					<dt class="col-sm-3">Tanggal</dt>
					<dd class="col-sm-3">
						<input type="text" id="tanggal_dok" name="tanggal_dok" 	class="form-control form-control-sm " readOnly>
					</dd>
					</dl>
				</div>
			</div>
			...
			<div class="modal-body">
				...
				<div class="col-sm-12">
					<dl class="row">
						...
						<dd class="col-sm-4">
							<input type="text" id="jumlah" value="" 	class="form-control form-control-sm " readOnly>
						</dd>
						<dd class="col-sm-4">
					...
					<dl class="row">
						...
						<dd class="col-sm-8">
							<input type="text" id="jenis" value="" 	class="form-control form-control-sm " readOnly>
						</dd>
					</dl>
					<dl class="row">
						<dt class="col-sm-4">Merk</dt>
						<dd class="col-sm-8">
							<input type="text" id="merk" value="" 	class="form-control form-control-sm " readOnly>
						</dd>
					</dl>
