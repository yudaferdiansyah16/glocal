<main id="js-page-content" role="main" class="page-content">
	<ol class="breadcrumb page-breadcrumb">
		...
		<li class="breadcrumb-item">Doc In</li>
		...
		<div class="col-sm-12 col-lg-12 col-xl-12">
			<div class="card mb-g">
				<div class="card-header">
					<a href="<?=base_url('exim/transaksi_doc_in/add')?>" class="btn btn-sm btn-primary">
					<i class="fal fa fa-plus-circle"></i> Add New</a>
				</div>
				<div class="card-body">
					<div class="row">
						...
						<div class="col-sm-12 col-lg-3">
							...
							<div class="input-group input-group-sm">
								<select class="form-control form-control-sm select2 supplier"  name="supplier" placeholder="Pilih Supplier/Customer" required>
