	...
	<div class="row">
		<div class="col-sm-12 col-lg-12 col-xl-12">
			<div class="card mb-g">
				...
				<?php
				if ($tpbHeader->KODE_DOKUMEN_PABEAN == '23') include 'edit_23.php';
				if ($tpbHeader->KODE_DOKUMEN_PABEAN == '262') include 'edit_262.php';
				if ($tpbHeader->KODE_DOKUMEN_PABEAN == '27IN') include 'edit_27IN.php';
				if ($tpbHeader->KODE_DOKUMEN_PABEAN == '40') include 'edit_40.php';
				?>
