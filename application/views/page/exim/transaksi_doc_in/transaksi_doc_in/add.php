...
<!--							</div>-->
							<div class="col-sm-12 col-lg-6 col-xl-6">
								<div class="row">
									...
									<div class="col-sm-12 col-lg-6 col-xl-6">
										...
										<div class="x-hidden dokumen_template include-40">
											<label class="form-label">
												Tujuan Pengiriman
											</label>
							...
							<div class="col-sm-12 col-lg-6 col-xl-6">
								<div class="row">
									<div class="col-sm-12 col-lg-6 col-xl-6">
										...
										<input type="text" name="tpb_header[JUMLAH_BARANG]" class="form-control form-control-sm input-mask" data-inputmask="'alias': 'currency', 'prefix': ''" >
									</div>
									<div class="col-sm-12 col-lg-6 col-xl-6">
									...
									<div class="col-sm-12 col-lg-6 col-xl-6 dokumen_template x-hidden include-40 include-27IN">
										<label class="form-label">Nama Pengangkut</label>
										<input type="text" name="tpb_header[NAMA_PENGANGKUT]" class="form-control form-control-sm "  >
									</div>
								</div>
							</div>
						</div>
						...
						<div class="form-group row">
							<div class="col-md-12">
								...
								<div class="table-responsive">
									<table class="table table-hover table-bordered table-striped table-sm dt_po_add" id="dt_doc_in_add" role="grid" style="white-space: nowrap;">
										<thead>
										<tr>
											<th class="text-center" width="5px">
												<button type="button" class="btn btn-xs btn-success" data-toggle="modal" data-target="#t_detail_dn_exim_in_modal"><i class="fal fa-plus-circle"></i></button>
											</th>
											<th class="text-center">No</th>
...
<table class="x-hidden" id="table-template">
	...
	<tr data-index="x">
		...
		<td class=" dokumen_template x-hidden include-40 include-27IN">
			<input type="text" class="form-control form-control-sm harga_penyerahan x-readonly input-mask"  data-inputmask="'alias': 'currency', 'prefix': ''"  readonly name="tpb_barang[x][HARGA_PENYERAHAN]"/>
		</td>
		...
		<td class=" dokumen_template x-hidden include-23 include-262">
			<input type="text" class="form-control form-control-sm harga_invoice x-readonly input-mask" data-inputmask="'alias': 'currency', 'prefix': ''" readonly name="tpb_barang[x][HARGA_INVOICE]" id="tpb_barang[x][HARGA_INVOICE]" />
			<input type="hidden" class="fob_barang" name="tpb_barang[x][FOB]"/>
			<input type="hidden" class="cif_barang" name="tpb_barang[x][CIF]"/>
		</td>
		<td class=" dokumen_template x-hidden include-23">
			<input type="text" class="form-control form-control-sm input-mask cif_rupiah_barang" name="tpb_barang[x][CIF_RUPIAH]" id="tpb_barang[x][CIF_RUPIAH]" data-inputmask="'alias': 'currency', 'prefix': ''"/>
		</td>
		<td>
			<input type="text" class="form-control form-control-sm input-mask" data-inputmask="'alias': 'currency', 'prefix': ''"  name="tpb_barang[x][NETTO]" />
		</td>
		<td>
		...
		<td>
			<input type="text" name="tpb_barang[x][JUMLAH_KEMASAN]" class="form-control form-control-sm input-mask" data-inputmask="'alias': 'currency', 'prefix': ''"  >
		</td>
		<td>
			<div class="input-group input-group-sm">
				<input type="text" class="form-control form-control-sm x-readonly" id="uraian_kemasan_barang[x]" readonly />
