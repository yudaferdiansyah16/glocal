					...
					<form method="post" action="<?= base_url('exim/posting_doc_in/store') ?>">
						<div class="form-group row">
							...
							<div class="col-sm-12 col-lg-4 col-xl-4">
								...
								<select class="form-control form-control-sm select2" name="id_jenis_dokumen" id="jenis_dokumen">
									<option value="" disabled selected>Select Data . . .</option>
						...
						<div class="x-hidden dokumen_template include-12">
							<div class="form-group row">
								<div class="col-md-3">
						...
						<div class="x-hidden dokumen_template include-16">
							<div class="form-group row">
								<div class="col-md-12">
									<div class="table-responsive">
										<table class="table table-sm" id="table-detail-262">
											<thead>
											<tr>
												...
												<th class="text-center">
													<button type="button" class="btn btn-success btn-xs btn-add-row-262"><i class="fa fal fa-plus-circle"></i></button>
												</th>
											</tr>
											</thead>
											<tbody>
						...
						<div class="form-group">
							<a href="<?=base_url('exim/posting_doc_in')?>" class="btn btn-sm btn-danger"><i class="fal fa-times-circle"></i> Cancel</a>
...
<table class="x-hidden table-template-262">
	<tbody>
	<tr>
		<td class="text-center">1</td>
		<td>
		...
		<td>
			<input type="text" class="form-control form-control-sm" name="no_bc_261" placeholder=""/>
		</td>
		<td>
			<div class="input-group input-group-sm">
				<input type="text" class="form-control form-control-sm x-datepicker x-readonly"
					   readonly placeholder="Select date" name="tanggal_bc_261">
				<div class="input-group-append">
					<span class="input-group-text fs-xl">
						<i class="fa fal fa-calendar"></i>
					</span>
