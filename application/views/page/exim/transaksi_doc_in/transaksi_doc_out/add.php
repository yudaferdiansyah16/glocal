						...
						<div class="form-group row">
							<div class="col-sm-12 col-lg-6 col-xl-6">
								...
								<div class="input-group input-group-sm">
									<input type="text" class="form-control form-control-sm x-readonly nama_pemasok_filter" readonly placeholder=""/>
									<input type="hidden" class="id_pemasok" name="id_pemasok"/>
...
<table class="x-hidden" id="table-template">
	...
	<tr data-index="x">
		...
		<td class="dokumen_template x-hidden include-25 include-30 include-261 include-27">
			<input type="text" class="form-control form-control-sm" name="tpb_barang[x][ASURANSI]"/>
		</td>
		<td class="dokumen_template x-hidden include-25 include-30 include-261 include-27">
			<input type="text" class="form-control form-control-sm" name="tpb_barang[x][DISKON]"/>
		</td>
...
<table class="x-hidden add_kemasan_template">
	...
	<tr data-index="x">
		...
		<td>
			<input type="text" class="form-control form-control-sm" name="tpb_kemasan[x][JUMLAH_KEMASAN]">
		</td>
	</tr>
	</tbody>
</table>
