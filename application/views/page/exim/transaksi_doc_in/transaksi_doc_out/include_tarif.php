<div class="x-hidden dokumen_template include-25 include-30 include-261" id="30">
		...
		<div class="col-sm-12 col-lg-12 col-xl-12">
			<table class="table table-sm table-bordered" style="table-layout: fixed">
				...
				<tr>
					...
					<td>
						<input type="text" class="form-control form-control-sm x-readonly "  readonly id="bm_tangguh" name="tpb_pungutan[0][NILAI_PUNGUTAN]">
						<input type="hidden" name="tpb_pungutan[0][JENIS_TARIF]" value="BM">
						<input type="hidden" name="tpb_pungutan[0][KODE_FASILITAS]" value="2">
					</td>
					<td>
						<input type="text" class="form-control form-control-sm x-readonly "  readonly id="bm_bebas" name="tpb_pungutan[1][NILAI_PUNGUTAN]">
						<input type="hidden" name="tpb_pungutan[1][JENIS_TARIF]" value="BM">
						<input type="hidden" name="tpb_pungutan[1][KODE_FASILITAS]" value="4">
					</td>
					<td>
						<input type="text" class="form-control form-control-sm x-readonly "  readonly id="bm_tidak" name="tpb_pungutan[2][NILAI_PUNGUTAN]">
				...
				<tr>
					...
					<td>
						<input type="text" class="form-control form-control-sm x-readonly "  readonly id="bmt_tangguh" name="tpb_pungutan[3][NILAI_PUNGUTAN]">
						<input type="hidden" name="tpb_pungutan[3][JENIS_TARIF]" value="BMT">
						<input type="hidden" name="tpb_pungutan[3][KODE_FASILITAS]" value="2">
					</td>
					<td>
						<input type="text" class="form-control form-control-sm x-readonly "  readonly id="bmt_bebas" name="tpb_pungutan[4][NILAI_PUNGUTAN]">
						<input type="hidden" name="tpb_pungutan[4][JENIS_TARIF]" value="BMT">
						<input type="hidden" name="tpb_pungutan[4][KODE_FASILITAS]" value="4">
					</td>
					<td>
						<input type="text" class="form-control form-control-sm x-readonly "  readonly id="bmt_tidak" name="tpb_pungutan[5][NILAI_PUNGUTAN]">
				...
				<tr>
					...
					<td>
						<input type="text" class="form-control form-control-sm x-readonly "  readonly id="cukai_tangguh" name="tpb_pungutan[6][NILAI_PUNGUTAN]">
					...
					<td>
						<input type="text" class="form-control form-control-sm x-readonly "  readonly id="cukai_bebas" name="tpb_pungutan[7][NILAI_PUNGUTAN]">
					...
					<td>
						<input type="text" class="form-control form-control-sm x-readonly "  readonly id="cukai_tidak" name="tpb_pungutan[8][NILAI_PUNGUTAN]">
				...
				<tr>
					...
					<td>
						<input type="text" class="form-control form-control-sm x-readonly "  readonly id="ppn_tangguh" name="tpb_pungutan[9][NILAI_PUNGUTAN]">
						<input type="hidden" name="tpb_pungutan[9][JENIS_TARIF]" value="PPN">
						<input type="hidden" name="tpb_pungutan[9][KODE_FASILITAS]" value="2">
					</td>
					<td>
						<input type="text" class="form-control form-control-sm x-readonly "  readonly id="ppn_bebas" name="tpb_pungutan[10][NILAI_PUNGUTAN]">
					...
					<td>
						<input type="text" class="form-control form-control-sm x-readonly "  readonly id="ppn_tidak" name="tpb_pungutan[11][NILAI_PUNGUTAN]">
				...
				<tr>
					...
					<td>
						<input type="text" class="form-control form-control-sm x-readonly "  readonly id="ppnbm_tangguh" name="tpb_pungutan[12][NILAI_PUNGUTAN]">
					...
					<td>
						<input type="text" class="form-control form-control-sm x-readonly "  readonly id="ppnbm_bebas" name="tpb_pungutan[13][NILAI_PUNGUTAN]">
					...
					<td>
						<input type="text" class="form-control form-control-sm x-readonly "  readonly id="ppnbm_tidak" name="tpb_pungutan[14][NILAI_PUNGUTAN]">
				...
				<tr>
					...
					<td>
						<input type="text" class="form-control form-control-sm x-readonly "  readonly id="pph_tangguh" name="tpb_pungutan[15][NILAI_PUNGUTAN]">
					...
					<td>
						<input type="text" class="form-control form-control-sm x-readonly "  readonly id="pph_bebas" name="tpb_pungutan[16][NILAI_PUNGUTAN]">
					...
					<td>
						<input type="text" class="form-control form-control-sm x-readonly "  readonly id="pph_tidak" name="tpb_pungutan[17][NILAI_PUNGUTAN]">
				...
				<tr>
					...
					<td><input type="text" class="form-control form-control-sm total_tangguh " id="total_tangguh" name="tpb_header[TOTAL_TANGGUH]"></td>
					<td><input type="text" class="form-control form-control-sm total_bebas " id="total_bebas" name="tpb_header[TOTAL_BEBAS]"></td>
					<td><input type="text" class="form-control form-control-sm total_tidak " id="total_tidak" name="tpb_header[TOTAL_TIDAK_DIPUNGUT]"></td>
				</tr>
			</table>
		</div>
	</div>
