...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tCaption = '<div class="file-caption form-control-sm form-control {class}" tabindex="500">\n' +
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    showZoom: true,
                    showDrag: true,
                    removeIcon: '<i class="fa fal fa-trash"></i>',
                    ...
                    zoomIcon: '<i class="fa fal fa-search-plus"></i>',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            ...
            toggleheader: '<i class="fa fal fa-sort-size-up"></i>',
            fullscreen: '<i class="fa fal fa-square-full"></i>',
            borderless: '<i class="fa fal fa-border-none"></i>',
            close: '<i class="fa fal fa-times"></i>'
        },
        previewZoomButtonClasses: {
            prev: 'btn btn-navigate',
            next: 'btn btn-navigate',
            toggleheader: 'btn btn-xs btn-kv btn-default btn-outline-secondary',
            fullscreen: 'btn btn-xs btn-kv btn-default btn-outline-secondary',
            borderless: 'btn btn-xs btn-kv btn-default btn-outline-secondary',
            close: 'btn btn-xs btn-kv btn-default btn-outline-secondary'
        },
        previewTemplates: {},
        previewContentTemplates: {},
        ...
        browseIcon: '<i class="fa fal fa-folder-open"></i>&nbsp;',
        ...
        uploadIcon: '<i class="fa fal fa-upload"></i>',
        uploadClass: 'btn btn-sm btn-success btn-secondary',
        uploadUrl: null,
        uploadUrlThumb: null,
        uploadAsync: true,
        uploadParamNames: {
