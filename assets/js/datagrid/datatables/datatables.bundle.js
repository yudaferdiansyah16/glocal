...
(function( $, window, document, undefined ) {
	...
	var DataTable = function ( options )
	{
		...
		this.fnDraw = function( complete )
		{
			...
			// into akun the new data, but can hold position.
		...
		this.each(function() {
			...
			{
				/* Display start point, taking into akun the save saving */
			...
			var loadedInit = function () {
				 ...
				 * akun, and also will apply sorting disabled classes if disabled
				 */
	...
	function _fnColumnOptions( oSettings, iCol, oOptions )
	{
		...
		/* Setting specified column options */
	...
	/**
	 * Covert the index of a visible column to the index in the data array (take akun
	 * of hidden columns)
	 *  @param {object} oSettings dataTables settings object
	 ...
	 *   column index (take akun of hidden columns)
	...
	/**
	 * Get the data for a given cell from the internal cache, taking into akun data mapping
	 *  @param {object} settings dataTables settings object
	...
	/**
	 * Split string on periods, taking into akun escaped periods
	 ...
	 * into akun the ability to use nested objects as a source
	...
	/**
	 * Redraw the table - taking akun of the various features which are enabled
	 *  @param {object} oSettings dataTables settings object
	...
	/**
	 * Create an Ajax call based on the table's settings, taking into akun that
	...
	function _fnFilter( settings, input, force, regex, smart, caseInsensitive )
	{
		...
		// Need to take akun of custom filtering functions - always filter
	...
	function _fnScrollDraw ( settings )
	{
		...
		// adjust the column sizes as the table width will have changed to akun
		// for the scrollbar
	 ...
	 *  @memberof DataTable#oApi
	 *  @todo This doesn't take akun of arrays inside the deep copied objects.
	 */
	...
	DataTable.defaults = {
		 ...
		 * akun of any changes you might have made to the initialisation object
	...
	DataTable.defaults.column = {
		 ...
		 * allows a column's ordering to take multiple columns into akun when
...
var AutoFill = function( dt, opts )
{
	...
	// Setting and defaults configuration object
	this.c = $.extend( true, {},
...
/**
 * Clone link and style tags, taking into akun the need to change the source
 * path.
 *
	...
	colvisRestore: {
		...
		action: function ( e, dt, button, conf ) {
			dt.columns().every( function ( i ) {
				// Take into akun that ColReorder might have disrupted our
				// indexes
...
$.fn.dataTableExt.oApi.fnColReorder = function ( oSettings, iFrom, iTo, drop, invalidateRows )
{
	...
	if ( oSettings.aoColumns[iFrom].bVisible )
	{
		 ...
		 * before needs to take into akun that there might not be an element to insert before,
...
$.extend( FixedColumns.prototype , {
	 ...
	 * the two is that this method takes into akun the fixed columns in the
	 ...
	 *  @param   {Object} oInit Setting settings for initialisation
	 *  @returns {void}
	 *  @private
	 */
	"_fnConstruct": function ( oInit )
	{
		...
		// When the mouse is down (drag scroll) the mouse master cannot
	...
	"_fnColCalc": function ()
	{
		...
		$.each( this.s.dt.aoColumns, function (i, col) {
			...
			else
			{
				...
				// akun of it, but it isn't in any cell
	...
	"_fnGridLayout": function ()
	{
		...
		if ( this.s.iRightColumns > 0 )
		{
			...
			// Need to take akun of the vertical scrollbar
			if ( this.s.rtl ) {
...
$.extend( FixedHeader.prototype, {
	...
	/**
	 * Reposition the floating elements to take akun of horizontal page
	 * scroll
	 *
	 * @param  {string} item       The `header` or `footer`
...
$.extend( KeyTable.prototype, {
	...
	_scroll: function ( container, scroller, cell, posOff )
	{
		...
		// needs to be taken akun of in the offset. If no Scroller, this will be 0
		if ( posOff === 'position' ) {
...
$.extend( Responsive.prototype, {
	...
	_columnsVisiblity: function ( breakpoint )
	{
		...
		// thrashing or overflow. Also we need to akun for the control column
	...
	_resizeAuto: function ()
	{
		...
		// Body rows - we don't need to take akun of DataTables' column
...
Responsive.display = {
	...
	childRowImmediate: function ( row, update, render ) {
		if ( (! update && row.child.isShown()) || ! row.responsive.hasHidden() ) {
			// Setting interaction and the row is show, or nothing to show
			row.child( false );
			$( row.node() ).removeClass( 'parent' );
...
$.extend( Scroller.prototype, {
	...
	*/
	...
	_domain: function ( dir, val )
	{
		...
		// Otherwise, we want a non-linear scrollbar to take akun of the
