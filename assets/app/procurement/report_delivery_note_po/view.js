...
$(document).ready(function(){
	...
	oTable = $('#dt').DataTable({
		...
		"info": true,
		"ajax": {
			url: _baseurl+"procurement/delivery_note_po/viewdetaildt",
			type: "POST",
			data: function(data){
		...
		"columns": [
			...
			{ data: "kode_dn", className: 'text-center', visible: false },
			...
			{ data: "qty_dn", className: 'text-right', render: renderMoney },
