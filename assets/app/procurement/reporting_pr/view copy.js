		...
		"columns": [
			{ data: "no", searchable: false, className: 'text-center' },
			{
				...
				render: function ( data, type, row ) {
					return "<p style='margin:0;padding:0;'> Nomor : "+row.NOMOR_AJU+"</p><small style='margin:0;padding:0;'> Tanggal :"+row.TANGGAL_AJU+"</small>";
				}
			},
			{ data: "TANGGAL_AJU",visible:false, className: 'text-center' },
			{
				data: "NOMOR_DAFTAR",
				render: function ( data, type, row ) {
					return "<p style='margin:0;padding:0;'> Nomor : "+row.NOMOR_DAFTAR+"</p><small style='margin:0;padding:0;'> Tanggal : "+row.TANGGAL_DAFTAR+"</small>";
				}
			},
			{ data: "TANGGAL_DAFTAR",visible:false, className: 'text-center' },
