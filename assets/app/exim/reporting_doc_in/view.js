...
$(document).ready(function() {
    ...
    oTable = $('#dt').DataTable({
        ...
        "info": true,
        "ajax": {
            url: _baseurl + "exim/reporting_doc_in/viewdt",
            type: "POST",
            data: function(data) {
                if ($('.tglajuawal').val() != '') data.tglajuawal = $('.tglajuawal').val();
                if ($('.tglajuakhir').val() != '') data.tglajuakhir = $('.tglajuakhir').val();
                if ($('.tglrecieveawal').val() != '') data.tglrecieveawal = $('.tglrecieveawal').val();
                if ($('.tglrecieveakhir').val() != '') data.tglrecieveakhir = $('.tglrecieveakhir').val();
